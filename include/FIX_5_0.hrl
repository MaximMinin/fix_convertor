...
-record( rgr_expirationQty_981, {expType :: expType(), expQty :: expQty()}).
...
-record( rgr_msgTypeGrp_384, {refMsgType :: refMsgType(), msgDirection :: msgDirection(), refApplVerID :: refApplVerID(), refCstmApplVerID :: refCstmApplVerID()}).
...
-record( rgr_instrmtLegExecGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legOrderQty :: legOrderQty(), legSwapType :: legSwapType(), legStipulations :: #legStipulations{}, legPositionEffect :: legPositionEffect(), legCoveredOrUncovered :: legCoveredOrUncovered(), nestedParties :: #nestedParties{}, legRefID :: legRefID(), legPrice :: legPrice(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legLastPx :: legLastPx(), legSettlCurrency :: legSettlCurrency(), legLastForwardPoints :: legLastForwardPoints(), legCalculatedCcyLastQty :: legCalculatedCcyLastQty(), legGrossTradeAmt :: legGrossTradeAmt()}).
...
-record( rgr_trdInstrmtLegGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legReportID :: legReportID(), legStipulations :: #legStipulations{}, legPositionEffect :: legPositionEffect(), legCoveredOrUncovered :: legCoveredOrUncovered(), nestedParties :: #nestedParties{}, legRefID :: legRefID(), legPrice :: legPrice(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legLastPx :: legLastPx(), legSettlCurrency :: legSettlCurrency(), legLastForwardPoints :: legLastForwardPoints(), legCalculatedCcyLastQty :: legCalculatedCcyLastQty(), legGrossTradeAmt :: legGrossTradeAmt()}).
...
-record( rgr_quotReqLegsGrp_555, {instrumentLeg :: #instrumentLeg{}, legOptionRatio :: legOptionRatio(), legPrice :: legPrice(), legQty :: legQty(), legOrderQty :: legOrderQty(), legSwapType :: legSwapType(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legStipulations :: #legStipulations{}, nestedParties :: #nestedParties{}, legBenchmarkCurveData :: #legBenchmarkCurveData{}, legRefID :: legRefID()}).
...
-record( rgr_legOrdGrp_555, {instrumentLeg :: #instrumentLeg{}, legOptionRatio :: legOptionRatio(), legQty :: legQty(), legSwapType :: legSwapType(), legStipulations :: #legStipulations{}, legPreAllocGrp :: #legPreAllocGrp{}, legPositionEffect :: legPositionEffect(), legCoveredOrUncovered :: legCoveredOrUncovered(), nestedParties :: #nestedParties{}, legRefID :: legRefID(), legPrice :: legPrice(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legOrderQty :: legOrderQty()}).
