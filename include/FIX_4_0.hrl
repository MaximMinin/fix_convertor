...
-type msgType () :: heartbeat|testRequest|resendRequest|reject|sequenceReset|logout|iOI|advertisement|executionReport|orderCancelReject|logon|news|email|orderSingle|orderList|orderCancelRequest|orderCancelReplaceRequest|orderStatusRequest|allocationInstruction|listCancelRequest|listExecute|listStatusRequest|listStatus|allocationInstructionAck|dontKnowTrade|quoteRequest|quote.
...
-record( rgr_allocation_73, {clOrdID :: clOrdID(), orderID :: orderID(), listID :: listID(), waveNo :: waveNo()}).
-record( rgr_allocation_124, {execID :: execID(), lastShares :: lastShares(), lastPx :: lastPx(), lastMkt :: lastMkt()}).
-record( rgr_allocation_136, {miscFeeAmt :: miscFeeAmt(), miscFeeCurr :: miscFeeCurr(), miscFeeType :: miscFeeType()}).
-record( rgr_allocation_78, {allocAccount :: allocAccount(), allocShares :: allocShares(), processCode :: processCode(), execBroker :: execBroker(), clientID :: clientID(), commission :: commission(), commType :: commType(), noDlvyInst :: noDlvyInst(), brokerOfCredit :: brokerOfCredit(), dlvyInst :: dlvyInst()}).
-record( allocationInstruction, {standardHeader :: #standardHeader{}, allocID :: allocID(), allocTransType :: allocTransType(), refAllocID :: refAllocID(), rgr_allocation_73 = [#rgr_allocation_73{}], rgr_allocation_124 = [#rgr_allocation_124{}], side :: side(), symbol :: symbol(), symbolSfx :: symbolSfx(), securityID :: securityID(), iDSource :: iDSource(), issuer :: issuer(), securityDesc :: securityDesc(), shares :: shares(), avgPx :: avgPx(), currency :: currency(), avgPrxPrecision :: avgPrxPrecision(), tradeDate :: tradeDate(), transactTime :: transactTime(), settlmntTyp :: settlmntTyp(), futSettDate :: futSettDate(), netMoney :: netMoney(), rgr_allocation_136 = [#rgr_allocation_136{}], settlCurrAmt :: settlCurrAmt(), settlCurrency :: settlCurrency(), openClose :: openClose(), text :: text(), rgr_allocation_78 = [#rgr_allocation_78{}], standardTrailer :: #standardTrailer{}}).
