...
-type couponPaymentDate () :: uTCDateOnly().
-type issueDate () :: uTCDateOnly().
-type repurchaseTerm () :: integer().
-type repurchaseRate () :: percentage().
-type factor () :: float().
-type tradeOriginationDate () :: uTCDateOnly().
-type exDate () :: uTCDateOnly().
...
-type redemptionDate () :: uTCDateOnly().
-type underlyingCouponPaymentDate () :: uTCDateOnly().
-type underlyingIssueDate () :: uTCDateOnly().
...
-type underlyingRedemptionDate () :: uTCDateOnly().
-type legCouponPaymentDate () :: uTCDateOnly().
-type legIssueDate () :: uTCDateOnly().
...
-type legRedemptionDate () :: uTCDateOnly().
...
-type basisFeatureDate () :: uTCDateOnly().
...
-type partyID () :: string().
-type totalVolumeTradedDate () :: uTCDateOnly().
...
-record( rgr_parties_453, {partyID :: partyID(), partyIDSource :: partyIDSource(), partyRole :: partyRole(), partySubID :: partySubID()}).
...
-record( logon, {standardHeader :: #standardHeader{}, encryptMethod :: encryptMethod(), heartBtInt :: heartBtInt(), rawDataLength :: rawDataLength(), rawData :: rawData(), resetSeqNumFlag :: resetSeqNumFlag(), maxMessageSize :: maxMessageSize(), rgr_logon_384 = [#rgr_logon_384{}], testMessageIndicator :: testMessageIndicator(), username :: username(), password :: password(), standardTrailer :: #standardTrailer{}}).
-record( rgr_news_215, {routingType :: routingType(), routingID :: routingID()}).
-record( rgr_news_146, {instrument :: #instrument{}}).
...
-record( rgr_email_146, {instrument :: #instrument{}}).
...
-record( rgr_newOrderSingle_78, {allocAccount :: allocAccount(), individualAllocID :: individualAllocID(), nestedParties :: #nestedParties{}, allocQty :: allocQty()}).
-record( rgr_newOrderSingle_386, {tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID()}).
...
-record( rgr_listStatus_73, {clOrdID :: clOrdID(), secondaryClOrdID :: secondaryClOrdID(), cumQty :: cumQty(), ordStatus :: ordStatus(), workingIndicator :: workingIndicator(), leavesQty :: leavesQty(), cxlQty :: cxlQty(), avgPx :: avgPx(), ordRejReason :: ordRejReason(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
...
-record( allocationInstructionAck, {standardHeader :: #standardHeader{}, parties :: #parties{}, allocID :: allocID(), tradeDate :: tradeDate(), transactTime :: transactTime(), allocStatus :: allocStatus(), allocRejCode :: allocRejCode(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), legalConfirm :: legalConfirm(), standardTrailer :: #standardTrailer{}}).
...
-record( rgr_marketDataRequest_146, {instrument :: #instrument{}}).
-record( rgr_marketDataRequest_386, {tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID()}).
-record( marketDataRequest, {standardHeader :: #standardHeader{}, mDReqID :: mDReqID(), subscriptionRequestType :: subscriptionRequestType(), marketDepth :: marketDepth(), mDUpdateType :: mDUpdateType(), aggregatedBook :: aggregatedBook(), openCloseSettleFlag :: openCloseSettleFlag(), scope :: scope(), mDImplicitDelete :: mDImplicitDelete(), rgr_marketDataRequest_267 = [#rgr_marketDataRequest_267{}], rgr_marketDataRequest_146 = [#rgr_marketDataRequest_146{}], rgr_marketDataRequest_386 = [#rgr_marketDataRequest_386{}], standardTrailer :: #standardTrailer{}}).
...
-record( rgr_quoteCancel_295, {instrument :: #instrument{}}).
...
-record( rgr_bidRequest_420, {listID :: listID(), side :: side(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), netGrossInd :: netGrossInd(), settlmntTyp :: settlmntTyp(), futSettDate :: futSettDate(), account :: account()}).
...
-record( rgr_listStrikePrice_428, {instrument :: #instrument{}, prevClosePx :: prevClosePx(), clOrdID :: clOrdID(), secondaryClOrdID :: secondaryClOrdID(), side :: side(), price :: price(), currency :: currency(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
...
-record( rgr_registrationInstructions_473, {registDetls :: registDetls(), registEmail :: registEmail(), mailingDtls :: mailingDtls(), mailingInst :: mailingInst(), nestedParties :: #nestedParties{}, ownerType :: ownerType(), dateOfBirth :: dateOfBirth(), investorCountryOfResidence :: investorCountryOfResidence()}).
-record( rgr_registrationInstructions_510, {distribPaymentMethod :: distribPaymentMethod(), distribPercentage :: distribPercentage(), cashDistribCurr :: cashDistribCurr(), cashDistribAgentName :: cashDistribAgentName(), cashDistribAgentCode :: cashDistribAgentCode(), cashDistribAgentAcctNumber :: cashDistribAgentAcctNumber(), cashDistribPayRef :: cashDistribPayRef()}).
-record( registrationInstructions, {standardHeader :: #standardHeader{}, registID :: registID(), registTransType :: registTransType(), registRefID :: registRefID(), clOrdID :: clOrdID(), parties :: #parties{}, account :: account(), registAcctType :: registAcctType(), taxAdvantageType :: taxAdvantageType(), ownershipType :: ownershipType(), rgr_registrationInstructions_473 = [#rgr_registrationInstructions_473{}], rgr_registrationInstructions_510 = [#rgr_registrationInstructions_510{}], standardTrailer :: #standardTrailer{}}).
...
-record( crossOrderCancelRequest, {standardHeader :: #standardHeader{}, orderID :: orderID(), crossID :: crossID(), origCrossID :: origCrossID(), crossType :: crossType(), crossPrioritization :: crossPrioritization(), rgr_crossOrderCancelRequest_552 = [#rgr_crossOrderCancelRequest_552{}], instrument :: #instrument{}, transactTime :: transactTime(), standardTrailer :: #standardTrailer{}}).
...
-record( rgr_securityTypes_558, {securityType :: securityType(), produkt :: produkt(), cFICode :: cFICode()}).
...
-record( quoteRequestReject, {standardHeader :: #standardHeader{}, quoteReqID :: quoteReqID(), rFQReqID :: rFQReqID(), quoteRequestRejectReason :: quoteRequestRejectReason(), rgr_quoteRequestReject_146 = [#rgr_quoteRequestReject_146{}], text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), standardTrailer :: #standardTrailer{}}).
-record( rgr_rFQRequest_146, {instrument :: #instrument{}, prevClosePx :: prevClosePx(), quoteRequestType :: quoteRequestType(), quoteType :: quoteType(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID()}).
-record( rFQRequest, {standardHeader :: #standardHeader{}, rFQReqID :: rFQReqID(), rgr_rFQRequest_146 = [#rgr_rFQRequest_146{}], subscriptionRequestType :: subscriptionRequestType(), standardTrailer :: #standardTrailer{}}).
