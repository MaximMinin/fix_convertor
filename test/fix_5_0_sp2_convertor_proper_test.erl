%% @author Maxim Minin 
%% @doc @todo Add description to fix_5_0_sp2_convertor_proper_test.
-module(fix_5_0_sp2_convertor_proper_test). 
...
-define(FIXVERSION, 'FIX 5.0 SP 2').
...
is_eq(Rec1, Rec2) -> 
    ...
    T1#standardTrailer{signature=not_to_check,
        ...
        T2#standardTrailer{signature=not_to_check,
                           checkSum = not_to_check}) 
        orelse
        erlang:is_record(Rec1, streamAssignmentRequest) %%TODO
        orelse
        erlang:is_record(Rec1, streamAssignmentReport). %%TODO
