...
-type securityIDSource () :: cUSIP|sEDOL|qUIK|iSINNumber|rICCode|iSOCurrencyCode|iSOCountryCode|exchangeSymbol|consolidatedTapeAssociation|bloombergSymbol|wertpapier|dutch|valoren|sicovam|belgian|common|clearingHouse|iSDAFpMLSpecification|optionPriceReportingAuthority|iSDAFpMLURL|letterOfCredit|marketplaceAssignedIdentifier.
-type iOIID () :: string.
...
-type text () :: string.
-type timeInForce () :: day|goodTillCancel|atTheOpening|immediateOrCancel|fillOrKill|goodTillCrossing|goodTillDate|atTheClose|goodThroughCrossing|atCrossing.
...
-type allocRejCode () :: unknownAccount|incorrectQuantity|incorrectAveragegPrice|unknownExecutingBrokerMnemonic|commissionDifference|unknownOrderID|unknownListID|otherSeeText|incorrectAllocatedQuantity|calculationDifference|unknownOrStaleExecID|mismatchedData|unknownClOrdID|warehouseRequestRejected|other.
-type signature () :: data.
...
-type cxlRejReason () :: tooLateToCancel|unknownOrder|brokerCredit|orderAlreadyInPendingStatus|unableToProcessOrderMassCancelRequest|origOrdModTime|duplicateClOrdID|priceExceedsCurrentPrice|priceExceedsCurrentPriceBand|invalidPriceIncrement|other.
-type ordRejReason () :: brokerCredit|unknownSymbol|exchangeClosed|orderExceedsLimit|tooLateToEnter|unknownOrder|duplicateOrder|duplicateOfAVerballyCommunicatedOrder|staleOrder|tradeAlongRequired|invalidInvestorID|unsupportedOrderCharacteristic|surveillenceOption|incorrectQuantity|incorrectAllocatedQuantity|unknownAccount|priceExceedsCurrentPriceBand|invalidPriceIncrement|other.
...
-type securityType () :: uSTreasuryNoteOld|uSTreasuryBillOld|euroSupranationalCoupons|federalAgencyCoupon|federalAgencyDiscountNote|privateExportFunding|uSDSupranationalCoupons|corporateBond|corporatePrivatePlacement|convertibleBond|dualCurrency|euroCorporateBond|euroCorporateFloatingRateNotes|uSCorporateFloatingRateNotes|indexedLinked|structuredNotes|yankeeCorporateBond|foreignExchangeContract|nonDeliverableForward|fXSpot|fXForward|fXSwap|creditDefaultSwap|future|option|optionsOnFutures|optionsOnPhysical|interestRateSwap|optionsOnCombo|commonStock|preferredStock|repurchase|forward|buySellback|securitiesLoan|securitiesPledge|bradyBond|canadianTreasuryNotes|canadianTreasuryBills|euroSovereigns|canadianProvincialBonds|treasuryBill|uSTreasuryBond|interestStripFromAnyBondOrNote|uSTreasuryBill|treasuryInflationProtectedSecurities|principalStripOfACallableBondOrNote|principalStripFromANonCallableBondOrNote|uSTreasuryNote|termLoan|revolverLoan|revolver|bridgeLoan|letterOfCredit|swingLineFacility|debtorInPossession|defaulted|withdrawn|replaced|matured|amended|retired|bankersAcceptance|bankDepositoryNote|bankNotes|billOfExchanges|canadianMoneyMarkets|certificateOfDeposit|callLoans|commercialPaper|depositNotes|euroCertificateOfDeposit|euroCommercialPaper|liquidityNote|mediumTermNotes|overnight|promissoryNote|shortTermLoanNote|plazosFijos|securedLiquidityNote|timeDeposit|termLiquidityNote|extendedCommNote|yankeeCertificateOfDeposit|assetBackedSecurities|canadianMortgageBonds|corp|collateralizedMortgageObligation|iOETTEMortgage|mortgageBackedSecurities|mortgageInterestOnly|mortgagePrincipalOnly|mortgagePrivatePlacement|miscellaneousPassThrough|pfandbriefe|toBeAnnounced|otherAnticipationNotes|certificateOfObligation|certificateOfParticipation|generalObligationBonds|mandatoryTender|revenueAnticipationNote|revenueBonds|specialAssessment|specialObligation|specialTax|taxAnticipationNote|taxAllocation|taxExemptCommercialPaper|taxableMunicipalCP|taxRevenueAnticipationNote|variableRateDemandNote|warrant|mutualFund|multilegInstrument|noSecurityType|wildcard|cash.
...
-type quoteStatus () :: accepted|cancelForSymbol|canceledForSecurityType|canceledForUnderlying|canceledAll|rejected|removedFromMarket|expired|queryqueryFix|quoteNotFound|pending|pass|lockedMarketWarning|crossMarketWarning|canceledDueToLockMarket|canceledDueToCrossMarket|active|canceled|unsolicitedQuoteReplenishment|pendingEndTrade|tooLateToEnd.
-type quoteCancelType () :: cancelForOneOrMoreSecurities|cancelForSecurityType|cancelForUnderlyingSecurity|cancelAllQuotes|cancelQuoteSpecifiedInQuoteID|cancelByQuoteType|cancelForSecurityIssuer|cancelForIssuerOfUnderlyingSecurity.
-type quoteEntryID () :: string.
-type quoteRejectReason () :: unknownSymbol|exchange|quoteRequestExceedsLimit|tooLateToEnter|unknownQuote|duplicateQuote|invalidBid|invalidPrice|notAuthorizedToQuoteSecurity|priceExceedsCurrentPriceBand|quoteLocked|invalidOrUnknownSecurityIssuer|invalidOrUnknownIssuerOfUnderlyingSecurity|other.
...
-type tradingSessionID () :: day|halfDay|morning|afternoon|evening|afterHours.
...
-type orderRestrictions () :: programTrade|indexArbitrage|nonIndexArbitrage|competingMarketMaker|actingAsMarketMakerOrSpecialistInSecurity|actingAsMarketMakerOrSpecialistInUnderlying|foreignEntity|externalMarketParticipant|externalInterConnectedMarketLinkage|risklessArbitrage|issuerHolding|issuePriceStabilization|nonAlgorithmic|algorithmic|cross.
-type massCancelRequestType () :: cancelOrdersForASecurity|cancelOrdersForAnUnderlyingSecurity|cancelOrdersForAProduct|cancelOrdersForACFICode|cancelOrdersForASecurityType|cancelOrdersForATradingSession|cancelAllOrders|cancelOrdersForAMarket|cancelOrdersForAMarketSegment|cancelOrdersForASecurityGroup|cancelOrdersForASecurity|cancelForIssuerOfUnderlyingSecurity.
...
-type matchType () :: onePartyTradeReport|twoPartyTradeReport|confirmedTradeReport|autoMatch|crossAuction|counterOrderSelection|callAuction|issuing|aCTAcceptedTrade|aCTDefaultTrade|aCTDefaultAfterM2|aCTM6Match|exactMatchPlus4BadgesExecTime|exactMatchPlus4Badges|exactMatchPlus2BadgesExecTime|exactMatchPlus2Badges|exactMatchPlusExecTime|stampedAdvisoriesOrSpecialistAccepts|a1ExactMatchSummarizedQuantity|a2ExactMatchSummarizedQuantity|a3ExactMatchSummarizedQuantity|a4ExactMatchSummarizedQuantity|a5ExactMatchSummarizedQuantity|exactMatchMinusBadgesTimes|summarizedMatchMinusBadgesTimes|oCSLockedIn.
...
-type posType () :: allocationTradeQty|optionAssignment|asOfTradeQty|deliveryQty|electronicTradeQty|optionExerciseQty|endOfDayQty|intraSpreadQty|interSpreadQty|adjustmentQty|pitTradeQty|startOfDayQty|integralSplit|transactionFromAssignment|totalTransactionQty|transactionQuantity|transferTradeQty|transactionFromExercise|crossMarginQty|receiveQuantity|corporateActionAdjustment|deliveryNoticeQty|exchangeForPhysicalQty|privatelyNegotiatedTradeQty|netDeltaQty|creditEventAdjustment|successionEventAdjustment.
-type longQty () :: qty.
-type shortQty () :: qty.
-type posQtyStatus () :: submitted|accepted|rejected.
-type posAmtType () :: cashAmount|cashResidualAmount|finalMarkToMarketAmount|incrementalMarkToMarketAmount|premiumAmount|startOfDayMarkToMarketAmount|tradeVariationAmount|valueAdjustedAmount|settlementValue|initialTradeCouponAmount|accruedCouponAmount|couponAmount|incrementalAccruedCoupon|collateralizedMarkToMarket|incrementalCollateralizedMarkToMarket|compensationAmount|totalBankedAmount|totalCollateralizedAmount.
-type posAmt () :: amt.
...
-type trdRegTimestampType () :: executionTime|timeIn|timeOut|brokerReceipt|brokerExecution|deskReceipt|submissionToClearing.
...
-type expirationCycle () :: expireOnTradingSessionClose|expireOnTradingSessionOpen|specifiedExpiration.
...
-type lastLiquidityInd () :: addedLiquidity|removedLiquidity|liquidityRoutedOut|auction.
...
-type userStatus () :: loggedIn|notLoggedIn|userNotRecognised|passwordIncorrect|passwordChanged|other|forcedUserLogoutByExchange|sessionShutdownWarning.
...
-type strategyParameterType () :: int|length|numInGroup|seqNum|tagNum|float|qty|pricepriceFix|priceOffset|amt|percentage|char|boolean|string|multipleCharValue|currencycurrencyFix|exchange|monthYear|uTCTimestamp|uTCTimeOnly|localMktDate|uTCDateOnly|data|multipleStringValue|countrycountryFix|language|tZTimeOnly|tZTimestamp|tenor.
...
-type expirationQtyType () :: autoExercise|nonAutoExercise|finalWillBeExercised|contraryIntention|difference.
-type expQty () :: qty.
...
-type unitOfMeasure () :: billionCubicFeet|millionBarrels|oneMillionBTU|megawattHours|barrels|bushels|pounds|gallons|troyOunces|metricTons|tons|uSDollars|allowances.
...
-type refOrderIDSource () :: secondaryOrderID|orderID|mDEntryID|quoteEntryID|originalOrderID.
-type secondaryDisplayQty () :: qty.
-type displayWhen () :: immediate|exhaust.
-type displayMethod () :: initial|new|random|undisclosed.
...
-type pegPriceType () :: lastPeg|midPricePeg|openingPeg|marketPeg|primaryPeg|pegToVWAP|trailingStopPeg|pegToLimitPrice.
...
-type applVerID () :: fIX27|fIX30|fIX40|fIX41|fIX42|fIX43|fIX44|fIX50|fIX50SP1|fIX50SP2.
...
-type underlyingMaturityTime () :: tZTimeOnly.
-type legMaturityTime () :: tZTimeOnly.
-type maxTradeVol () :: qty.
-type noMDFeedTypes () :: numInGroup.
-type matchAlgorithm () :: string.
-type maxPriceVariation () :: float.
-type impliedMarketIndicator () :: notImplied|impliedIn|impliedOut|bothImpliedInAndImpliedOut.
-type eventTime () :: uTCTimestamp.
-type minPriceIncrementAmount () :: amt.
-type unitOfMeasureQty () :: qty.
-type lowLimitPrice () :: price.
...
-type ccyAmt () :: amt.
-type noSettlDetails () :: numInGroup.
-type settlObligMode () :: preliminary|final.
-type settlObligMsgID () :: string.
-type settlObligID () :: string.
-type settlObligTransType () :: cancel|new|replace|restate.
-type settlObligRefID () :: string.
-type settlObligSource () :: instructionsOfBroker|instructionsForInstitution|investor.
...
-type timeToExpiration () :: float.
-type riskFreeRate () :: float.
-type priceUnitOfMeasure () :: string.
...
-type listMethod () :: preListedOnly|userRequested.
-type capPrice () :: price.
-type floorPrice () :: price.
-type noStrikeRules () :: numInGroup.
-type startStrikePxRange () :: price.
-type endStrikePxRange () :: price.
-type strikeIncrement () :: float.
-type noTickRules () :: numInGroup.
-type startTickPriceRange () :: price.
...
-type derivativeSecurityID () :: string.
-type derivativeSecurityIDSource () :: string.
-type noDerivativeSecurityAltID () :: numInGroup.
-type derivativeSecurityAltID () :: string.
-type derivativeSecurityAltIDSource () :: string.
-type secondaryLowLimitPrice () :: price.
-type secondaryHighLimitPrice () :: price.
-type maturityRuleID () :: string.
-type strikeRuleID () :: string.
-type derivativeOptPayAmount () :: amt.
...
-type noMatchRules () :: numInGroup.
-type noMaturityRules () :: numInGroup.
-type noOrdTypeRules () :: numInGroup.
-type noTimeInForceRules () :: numInGroup.
-type secondaryTradingReferencePrice () :: price.
-type startMaturityMonthYear () :: monthYear.
-type flexProductEligibilityIndicator () :: boolean.
...
-type derivativeSecuritySubType () :: string.
-type derivativeMaturityMonthYear () :: monthYear.
...
-type derivativeStateOrProvinceOfIssue () :: string.
-type derivativeLocaleOfIssue () :: string.
-type derivativeStrikePrice () :: price.
...
-type derivativeUnitOfMeasure () :: string.
...
-type derivativeEncodedIssuer () :: data.
-type derivativeSecurityDesc () :: string.
...
-type derivativeEventText () :: string.
...
-type underlyingUnitOfMeasureQty () :: qty.
-type underlyingPriceUnitOfMeasure () :: string.
-type underlyingPriceUnitOfMeasureQty () :: qty.
-type marketReqID () :: string.
-type marketReportID () :: string.
-type marketUpdateAction () :: add|delete|modify.
-type marketSegmentDesc () :: string.
-type encodedMktSegmDescLen () :: length.
...
-type underlyingLegSymbolSfx () :: string.
-type underlyingLegSecurityID () :: string.
-type underlyingLegSecurityIDSource () :: string.
-type noUnderlyingLegSecurityAltID () :: numInGroup.
-type underlyingLegSecurityAltID () :: string.
-type underlyingLegSecurityAltIDSource () :: string.
...
-type fillPx () :: price.
-type fillQty () :: qty.
-type legAllocID () :: string.
-type tradSesEvent () :: tradingResumes|changeOfTradingSession|changeOfTradingSubsession|changeOfTradingStatus.
-type massActionReportID () :: string.
-type noNotAffectedOrders () :: numInGroup.
-type notAffectedOrderID () :: string.
-type notAffOrigClOrdID () :: string.
-type massActionType () :: suspendOrders|releaseOrdersFromSuspension|cancelOrders.
-type massActionScope () :: allOrdersForASecurity|allOrdersForAnUnderlyingSecurity|allOrdersForAProduct|allOrdersForACFICode|allOrdersForASecurityType|allOrdersForATradingSession|allOrders|allOrdersForAMarket|allOrdersForAMarketSegment|allOrdersForASecurityGroup|cancelForSecurityIssuer|cancelForIssuerOfUnderlyingSecurity.
-type massActionResponse () :: rejected|accepted.
-type massActionRejectReason () :: massActionNotSupported|invalidOrUnknownSecurity|invalidOrUnknownUnderlyingSecurity|invalidOrUnknownProduct|invalidOrUnknownCFICode|invalidOrUnknownSecurityType|invalidOrUnknownTradingSession|invalidOrUnknownMarket|invalidOrUnknownMarketSegment|invalidOrUnknownSecurityGroup|invalidOrUnknownSecurityIssuer|invalidOrUnknownIssuerOfUnderlyingSecurity|other.
-type multilegModel () :: predefinedMultilegSecurity|userDefinedMultilegSecurity|userDefined.
-type multilegPriceMethod () :: netPrice|reversedNetPrice|yieldDifference|individual|contractWeightedAveragePrice|multipliedPrice.
-type legVolatility () :: float.
-type dividendYield () :: percentage.
-type legDividendYield () :: percentage.
-type currencyRatio () :: float.
-type legCurrencyRatio () :: float.
-type legExecInst () :: multipleCharValue.
...
-type applReqType () :: retransmission|subscription|requestLastSeqNum|requestApplications|unsubscribe|retransmission|cancelRetransmissionUnsubscribe.
...
-type applResponseID () :: string.
-type applResponseError () :: applicationDoesNotExist|messagesRequestedAreNotAvailable|userNotAuthorizedForApplication.
-type refApplID () :: string.
-type applReportID () :: string.
...
-type origCustOrderCapacity () :: memberTradingForTheirOwnAccount|clearingFirmTradingForItsProprietaryAccount|memberTradingForAnotherMember|allOther.
...
-type seniority () :: seniorSecured|senior|subordinated.
-type notionalPercentageOutstanding () :: percentage.
-type originalNotionalPercentageOutstanding () :: percentage.
-type underlyingRestructuringType () :: string.
-type underlyingSeniority () :: string.
-type underlyingNotionalPercentageOutstanding () :: percentage.
-type underlyingOriginalNotionalPercentageOutstanding () :: percentage.
-type attachmentPoint () :: percentage.
-type detachmentPoint () :: percentage.
-type underlyingAttachmentPoint () :: percentage.
...
-type encodedSecurityListDescLen () :: length.
-type encodedSecurityListDesc () :: data.
-type securityListType () :: industryClassification|tradingList|market|newspaperList.
-type securityListTypeSource () :: iCB|nAICS|gICS.
-type newsID () :: string.
-type newsCategory () :: companyNews|marketplaceNews|financialMarketNews|technicalNews|otherNews.
-type languageCode () :: language.
-type noNewsRefIDs () :: numInGroup.
-type newsRefID () :: string.
-type newsRefType () :: replacement|otherLanguage|complimentary.
-type strikePriceDeterminationMethod () :: fixedStrike|strikeSetAtExpiration|strikeSetToAverageAcrossLife|strikeSetToOptimalValue.
-type strikePriceBoundaryMethod () :: lessThan|lessThanOrEqual|equal|greaterThanOrEqual|greaterThan.
-type strikePriceBoundaryPrecision () :: percentage.
-type underlyingPriceDeterminationMethod () :: regular|specialReference|optimalValue|regular.
-type optPayoutType () :: vanilla|capped|binary.
-type noComplexEvents () :: numInGroup.
-type complexEventType () :: capped|trigger|knockInUp|kockInDown|knockOutUp|knockOutDown|underlying|resetBarrier|rollingBarrier.
-type complexOptPayoutAmount () :: amt.
-type complexEventPrice () :: price.
-type complexEventPriceBoundaryMethod () :: lessThanComplexEventPrice|lessThanOrEqualToComplexEventPrice|equalToComplexEventPrice|greaterThanOrEqualToComplexEventPrice|greaterThanComplexEventPrice.
-type complexEventPriceBoundaryPrecision () :: percentage.
-type complexEventPriceTimeType () :: expiration|immediate|specifiedDate.
-type complexEventCondition () :: andandFix|ororFix.
-type noComplexEventDates () :: numInGroup.
-type complexEventStartDate () :: uTCTimestamp.
-type complexEventEndDate () :: uTCTimestamp.
-type noComplexEventTimes () :: numInGroup.
-type complexEventStartTime () :: uTCTimeOnly.
-type complexEventEndTime () :: uTCTimeOnly.
-type streamAsgnReqID () :: string.
-type streamAsgnReqType () :: streamAssignmentForNewCustomer|streamAssignmentForExistingCustomer.
-type noAsgnReqs () :: numInGroup.
-type mDStreamID () :: string.
-type streamAsgnRptID () :: string.
-type streamAsgnRejReason () :: unknownClient|exceedsMaximumSize|unknownOrInvalidCurrencyPair|noAvailableStream|other.
-type streamAsgnAckType () :: assignmentAccepted|assignmentRejected.
-type streamAsgnType () :: assignment|rejected|terminate.
-type relSymTransactTime () :: uTCTimestamp.
...
-record( rgr_legStipulations_683, {legStipulationType :: legStipulationType(), legStipulationValue :: legStipulationValue()}).
-record( legStipulations, {rgr_legStipulations_683 = [#rgr_legStipulations_683{}]}).
...
-record( rgr_positionAmountData_753, {posAmtType :: posAmtType(), posAmt :: posAmt(), positionCurrency :: positionCurrency()}).
-record( positionAmountData, {rgr_positionAmountData_753 = [#rgr_positionAmountData_753{}]}).
...
-record( rgr_stipulations_232, {stipulationType :: stipulationType(), stipulationValue :: stipulationValue()}).
-record( stipulations, {rgr_stipulations_232 = [#rgr_stipulations_232{}]}).
-record( rgr_trdRegTimestamps_768, {trdRegTimestamp :: trdRegTimestamp(), trdRegTimestampType :: trdRegTimestampType(), trdRegTimestampOrigin :: trdRegTimestampOrigin(), deskType :: deskType(), deskTypeSource :: deskTypeSource(), deskOrderHandlingInst :: deskOrderHandlingInst()}).
-record( trdRegTimestamps, {rgr_trdRegTimestamps_768 = [#rgr_trdRegTimestamps_768{}]}).
...
-record( rgr_underlyingStipulations_887, {underlyingStipType :: underlyingStipType(), underlyingStipValue :: underlyingStipValue()}).
-record( underlyingStipulations, {rgr_underlyingStipulations_887 = [#rgr_underlyingStipulations_887{}]}).
-record( standardTrailer, {signatureLength :: signatureLength(), signature :: signature(), checkSum :: checkSum()}).
-record( rgr_affectedOrdGrp_534, {origClOrdID :: origClOrdID(), affectedOrderID :: affectedOrderID(), affectedSecondaryOrderID :: affectedSecondaryOrderID()}).
-record( affectedOrdGrp, {rgr_affectedOrdGrp_534 = [#rgr_affectedOrdGrp_534{}]}).
-record( rgr_bidCompReqGrp_420, {listID :: listID(), side :: side(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), netGrossInd :: netGrossInd(), settlType :: settlType(), settlDate :: settlDate(), account :: account(), acctIDSource :: acctIDSource()}).
-record( bidCompReqGrp, {rgr_bidCompReqGrp_420 = [#rgr_bidCompReqGrp_420{}]}).
-record( rgr_bidDescReqGrp_398, {bidDescriptorType :: bidDescriptorType(), bidDescriptor :: bidDescriptor(), sideValueInd :: sideValueInd(), liquidityValue :: liquidityValue(), liquidityNumSecurities :: liquidityNumSecurities(), liquidityPctLow :: liquidityPctLow(), liquidityPctHigh :: liquidityPctHigh(), eFPTrackingError :: eFPTrackingError(), fairValue :: fairValue(), outsideIndexPct :: outsideIndexPct(), valueOfFutures :: valueOfFutures()}).
-record( bidDescReqGrp, {rgr_bidDescReqGrp_398 = [#rgr_bidDescReqGrp_398{}]}).
-record( rgr_clrInstGrp_576, {clearingInstruction :: clearingInstruction()}).
-record( clrInstGrp, {rgr_clrInstGrp_576 = [#rgr_clrInstGrp_576{}]}).
-record( rgr_collInqQualGrp_938, {collInquiryQualifier :: collInquiryQualifier()}).
-record( collInqQualGrp, {rgr_collInqQualGrp_938 = [#rgr_collInqQualGrp_938{}]}).
-record( rgr_compIDReqGrp_936, {refCompID :: refCompID(), refSubID :: refSubID(), locationID :: locationID(), deskID :: deskID()}).
-record( compIDReqGrp, {rgr_compIDReqGrp_936 = [#rgr_compIDReqGrp_936{}]}).
-record( rgr_compIDStatGrp_936, {refCompID :: refCompID(), refSubID :: refSubID(), locationID :: locationID(), deskID :: deskID(), statusValue :: statusValue(), statusText :: statusText()}).
-record( compIDStatGrp, {rgr_compIDStatGrp_936 = [#rgr_compIDStatGrp_936{}]}).
-record( rgr_contAmtGrp_518, {contAmtType :: contAmtType(), contAmtValue :: contAmtValue(), contAmtCurr :: contAmtCurr()}).
-record( contAmtGrp, {rgr_contAmtGrp_518 = [#rgr_contAmtGrp_518{}]}).
-record( rgr_contraGrp_382, {contraBroker :: contraBroker(), contraTrader :: contraTrader(), contraTradeQty :: contraTradeQty(), contraTradeTime :: contraTradeTime(), contraLegRefID :: contraLegRefID()}).
-record( contraGrp, {rgr_contraGrp_382 = [#rgr_contraGrp_382{}]}).
-record( rgr_cpctyConfGrp_862, {orderCapacity :: orderCapacity(), orderRestrictions :: orderRestrictions(), orderCapacityQty :: orderCapacityQty()}).
-record( cpctyConfGrp, {rgr_cpctyConfGrp_862 = [#rgr_cpctyConfGrp_862{}]}).
-record( rgr_execAllocGrp_124, {lastQty :: lastQty(), execID :: execID(), secondaryExecID :: secondaryExecID(), lastPx :: lastPx(), lastParPx :: lastParPx(), lastCapacity :: lastCapacity(), tradeID :: tradeID(), firmTradeID :: firmTradeID()}).
-record( execAllocGrp, {rgr_execAllocGrp_124 = [#rgr_execAllocGrp_124{}]}).
-record( rgr_execCollGrp_124, {execID :: execID()}).
-record( execCollGrp, {rgr_execCollGrp_124 = [#rgr_execCollGrp_124{}]}).
-record( rgr_iOIQualGrp_199, {iOIQualifier :: iOIQualifier()}).
-record( iOIQualGrp, {rgr_iOIQualGrp_199 = [#rgr_iOIQualGrp_199{}]}).
-record( rgr_linesOfTextGrp_33, {text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( linesOfTextGrp, {rgr_linesOfTextGrp_33 = [#rgr_linesOfTextGrp_33{}]}).
-record( rgr_mDReqGrp_267, {mDEntryType :: mDEntryType()}).
-record( mDReqGrp, {rgr_mDReqGrp_267 = [#rgr_mDReqGrp_267{}]}).
-record( rgr_mDRjctGrp_816, {altMDSourceID :: altMDSourceID()}).
-record( mDRjctGrp, {rgr_mDRjctGrp_816 = [#rgr_mDRjctGrp_816{}]}).
-record( rgr_miscFeesGrp_136, {miscFeeAmt :: miscFeeAmt(), miscFeeCurr :: miscFeeCurr(), miscFeeType :: miscFeeType(), miscFeeBasis :: miscFeeBasis()}).
-record( miscFeesGrp, {rgr_miscFeesGrp_136 = [#rgr_miscFeesGrp_136{}]}).
-record( rgr_ordListStatGrp_73, {clOrdID :: clOrdID(), orderID :: orderID(), secondaryClOrdID :: secondaryClOrdID(), cumQty :: cumQty(), ordStatus :: ordStatus(), workingIndicator :: workingIndicator(), leavesQty :: leavesQty(), cxlQty :: cxlQty(), avgPx :: avgPx(), ordRejReason :: ordRejReason(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( ordListStatGrp, {rgr_ordListStatGrp_73 = [#rgr_ordListStatGrp_73{}]}).
-record( rgr_quotQualGrp_735, {quoteQualifier :: quoteQualifier()}).
-record( quotQualGrp, {rgr_quotQualGrp_735 = [#rgr_quotQualGrp_735{}]}).
-record( rgr_rgstDistInstGrp_510, {distribPaymentMethod :: distribPaymentMethod(), distribPercentage :: distribPercentage(), cashDistribCurr :: cashDistribCurr(), cashDistribAgentName :: cashDistribAgentName(), cashDistribAgentCode :: cashDistribAgentCode(), cashDistribAgentAcctNumber :: cashDistribAgentAcctNumber(), cashDistribPayRef :: cashDistribPayRef(), cashDistribAgentAcctName :: cashDistribAgentAcctName()}).
-record( rgstDistInstGrp, {rgr_rgstDistInstGrp_510 = [#rgr_rgstDistInstGrp_510{}]}).
-record( rgr_routingGrp_215, {routingType :: routingType(), routingID :: routingID()}).
-record( routingGrp, {rgr_routingGrp_215 = [#rgr_routingGrp_215{}]}).
-record( rgr_secTypesGrp_558, {securityType :: securityType(), securitySubType :: securitySubType(), produkt :: produkt(), cFICode :: cFICode(), transactTime :: transactTime()}).
-record( secTypesGrp, {rgr_secTypesGrp_558 = [#rgr_secTypesGrp_558{}]}).
-record( rgr_trdCollGrp_897, {tradeReportID :: tradeReportID(), secondaryTradeReportID :: secondaryTradeReportID()}).
-record( trdCollGrp, {rgr_trdCollGrp_897 = [#rgr_trdCollGrp_897{}]}).
-record( rgr_trdgSesGrp_386, {tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID()}).
-record( trdgSesGrp, {rgr_trdgSesGrp_386 = [#rgr_trdgSesGrp_386{}]}).
-record( rgr_trdCapDtGrp_580, {tradeDate :: tradeDate(), lastUpdateTime :: lastUpdateTime(), transactTime :: transactTime()}).
-record( trdCapDtGrp, {rgr_trdCapDtGrp_580 = [#rgr_trdCapDtGrp_580{}]}).
-record( rgr_evntGrp_864, {eventType :: eventType(), eventDate :: eventDate(), eventTime :: eventTime(), eventPx :: eventPx(), eventText :: eventText()}).
-record( evntGrp, {rgr_evntGrp_864 = [#rgr_evntGrp_864{}]}).
-record( rgr_secAltIDGrp_454, {securityAltID :: securityAltID(), securityAltIDSource :: securityAltIDSource()}).
-record( secAltIDGrp, {rgr_secAltIDGrp_454 = [#rgr_secAltIDGrp_454{}]}).
-record( rgr_legSecAltIDGrp_604, {legSecurityAltID :: legSecurityAltID(), legSecurityAltIDSource :: legSecurityAltIDSource()}).
-record( legSecAltIDGrp, {rgr_legSecAltIDGrp_604 = [#rgr_legSecAltIDGrp_604{}]}).
-record( rgr_undSecAltIDGrp_457, {underlyingSecurityAltID :: underlyingSecurityAltID(), underlyingSecurityAltIDSource :: underlyingSecurityAltIDSource()}).
-record( undSecAltIDGrp, {rgr_undSecAltIDGrp_457 = [#rgr_undSecAltIDGrp_457{}]}).
-record( rgr_attrbGrp_870, {instrAttribType :: instrAttribType(), instrAttribValue :: instrAttribValue()}).
-record( attrbGrp, {rgr_attrbGrp_870 = [#rgr_attrbGrp_870{}]}).
-record( rgr_settlPtysSubGrp_801, {settlPartySubID :: settlPartySubID(), settlPartySubIDType :: settlPartySubIDType()}).
-record( settlPtysSubGrp, {rgr_settlPtysSubGrp_801 = [#rgr_settlPtysSubGrp_801{}]}).
-record( rgr_ptysSubGrp_802, {partySubID :: partySubID(), partySubIDType :: partySubIDType()}).
-record( ptysSubGrp, {rgr_ptysSubGrp_802 = [#rgr_ptysSubGrp_802{}]}).
-record( rgr_nstdPtysSubGrp_804, {nestedPartySubID :: nestedPartySubID(), nestedPartySubIDType :: nestedPartySubIDType()}).
-record( nstdPtysSubGrp, {rgr_nstdPtysSubGrp_804 = [#rgr_nstdPtysSubGrp_804{}]}).
...
-record( rgr_nstdPtys2SubGrp_806, {nested2PartySubID :: nested2PartySubID(), nested2PartySubIDType :: nested2PartySubIDType()}).
-record( nstdPtys2SubGrp, {rgr_nstdPtys2SubGrp_806 = [#rgr_nstdPtys2SubGrp_806{}]}).
-record( rgr_nstdPtys3SubGrp_952, {nested3PartySubID :: nested3PartySubID(), nested3PartySubIDType :: nested3PartySubIDType()}).
-record( nstdPtys3SubGrp, {rgr_nstdPtys3SubGrp_952 = [#rgr_nstdPtys3SubGrp_952{}]}).
-record( rgr_strategyParametersGrp_957, {strategyParameterName :: strategyParameterName(), strategyParameterType :: strategyParameterType(), strategyParameterValue :: strategyParameterValue()}).
-record( strategyParametersGrp, {rgr_strategyParametersGrp_957 = [#rgr_strategyParametersGrp_957{}]}).
-record( rgr_underlyingAmount_984, {underlyingPayAmount :: underlyingPayAmount(), underlyingCollectAmount :: underlyingCollectAmount(), underlyingSettlementDate :: underlyingSettlementDate(), underlyingSettlementStatus :: underlyingSettlementStatus()}).
-record( underlyingAmount, {rgr_underlyingAmount_984 = [#rgr_underlyingAmount_984{}]}).
-record( rgr_expirationQty_981, {expirationQtyType :: expirationQtyType(), expQty :: expQty()}).
-record( expirationQty, {rgr_expirationQty_981 = [#rgr_expirationQty_981{}]}).
-record( rgr_instrumentPtysSubGrp_1052, {instrumentPartySubID :: instrumentPartySubID(), instrumentPartySubIDType :: instrumentPartySubIDType()}).
-record( instrumentPtysSubGrp, {rgr_instrumentPtysSubGrp_1052 = [#rgr_instrumentPtysSubGrp_1052{}]}).
-record( rgr_sideTrdRegTS_1016, {sideTrdRegTimestamp :: sideTrdRegTimestamp(), sideTrdRegTimestampType :: sideTrdRegTimestampType(), sideTrdRegTimestampSrc :: sideTrdRegTimestampSrc()}).
-record( sideTrdRegTS, {rgr_sideTrdRegTS_1016 = [#rgr_sideTrdRegTS_1016{}]}).
-record( rgr_undlyInstrumentPtysSubGrp_1062, {underlyingInstrumentPartySubID :: underlyingInstrumentPartySubID(), underlyingInstrumentPartySubIDType :: underlyingInstrumentPartySubIDType()}).
-record( undlyInstrumentPtysSubGrp, {rgr_undlyInstrumentPtysSubGrp_1062 = [#rgr_undlyInstrumentPtysSubGrp_1062{}]}).
...
-record( rgr_rootSubParties_1120, {rootPartySubID :: rootPartySubID(), rootPartySubIDType :: rootPartySubIDType()}).
-record( rootSubParties, {rgr_rootSubParties_1120 = [#rgr_rootSubParties_1120{}]}).
-record( rgr_msgTypeGrp_384, {refMsgType :: refMsgType(), msgDirection :: msgDirection(), refApplVerID :: refApplVerID(), refApplExtID :: refApplExtID(), refCstmApplVerID :: refCstmApplVerID(), defaultVerIndicator :: defaultVerIndicator()}).
-record( msgTypeGrp, {rgr_msgTypeGrp_384 = [#rgr_msgTypeGrp_384{}]}).
-record( rgr_secSizesGrp_1177, {mDSecSizeType :: mDSecSizeType(), mDSecSize :: mDSecSize()}).
...
-record( maturityRules, {rgr_maturityRules_1236 = [#rgr_maturityRules_1236{}]}).
...
-record( rgr_marketDataFeedTypes_1141, {mDFeedType :: mDFeedType(), marketDepth :: marketDepth(), mDBookType :: mDBookType()}).
-record( marketDataFeedTypes, {rgr_marketDataFeedTypes_1141 = [#rgr_marketDataFeedTypes_1141{}]}).
-record( rgr_lotTypeRules_1234, {lotType :: lotType(), minLotSize :: minLotSize()}).
-record( lotTypeRules, {rgr_lotTypeRules_1234 = [#rgr_lotTypeRules_1234{}]}).
-record( rgr_matchRules_1235, {matchAlgorithm :: matchAlgorithm(), matchType :: matchType()}).
-record( matchRules, {rgr_matchRules_1235 = [#rgr_matchRules_1235{}]}).
-record( rgr_execInstRules_1232, {execInstValue :: execInstValue()}).
-record( execInstRules, {rgr_execInstRules_1232 = [#rgr_execInstRules_1232{}]}).
-record( rgr_timeInForceRules_1239, {timeInForce :: timeInForce()}).
-record( timeInForceRules, {rgr_timeInForceRules_1239 = [#rgr_timeInForceRules_1239{}]}).
-record( rgr_ordTypeRules_1237, {ordType :: ordType()}).
-record( ordTypeRules, {rgr_ordTypeRules_1237 = [#rgr_ordTypeRules_1237{}]}).
-record( rgr_derivativeInstrumentPartySubIDsGrp_1296, {derivativeInstrumentPartySubID :: derivativeInstrumentPartySubID(), derivativeInstrumentPartySubIDType :: derivativeInstrumentPartySubIDType()}).
-record( derivativeInstrumentPartySubIDsGrp, {rgr_derivativeInstrumentPartySubIDsGrp_1296 = [#rgr_derivativeInstrumentPartySubIDsGrp_1296{}]}).
-record( rgr_derivativeInstrumentAttribute_1311, {derivativeInstrAttribType :: derivativeInstrAttribType(), derivativeInstrAttribValue :: derivativeInstrAttribValue()}).
-record( derivativeInstrumentAttribute, {rgr_derivativeInstrumentAttribute_1311 = [#rgr_derivativeInstrumentAttribute_1311{}]}).
-record( rgr_nestedInstrumentAttribute_1312, {nestedInstrAttribType :: nestedInstrAttribType(), nestedInstrAttribValue :: nestedInstrAttribValue()}).
-record( nestedInstrumentAttribute, {rgr_nestedInstrumentAttribute_1312 = [#rgr_nestedInstrumentAttribute_1312{}]}).
-record( rgr_derivativeSecurityAltIDGrp_1218, {derivativeSecurityAltID :: derivativeSecurityAltID(), derivativeSecurityAltIDSource :: derivativeSecurityAltIDSource()}).
...
-record( usernameGrp, {rgr_usernameGrp_809 = [#rgr_usernameGrp_809{}]}).
-record( rgr_notAffectedOrdersGrp_1370, {notAffOrigClOrdID :: notAffOrigClOrdID(), notAffectedOrderID :: notAffectedOrderID()}).
-record( notAffectedOrdersGrp, {rgr_notAffectedOrdersGrp_1370 = [#rgr_notAffectedOrdersGrp_1370{}]}).
-record( rgr_trdRepIndicatorsGrp_1387, {trdRepPartyRole :: trdRepPartyRole(), trdRepIndicator :: trdRepIndicator()}).
-record( trdRepIndicatorsGrp, {rgr_trdRepIndicatorsGrp_1387 = [#rgr_trdRepIndicatorsGrp_1387{}]}).
...
-record( rgr_applIDReportGrp_1351, {refApplID :: refApplID(), applNewSeqNum :: applNewSeqNum(), refApplLastSeqNum :: refApplLastSeqNum()}).
...
-record( rgr_newsRefGrp_1475, {newsRefID :: newsRefID(), newsRefType :: newsRefType()}).
-record( newsRefGrp, {rgr_newsRefGrp_1475 = [#rgr_newsRefGrp_1475{}]}).
-record( rgr_complexEventTimes_1494, {complexEventStartTime :: complexEventStartTime(), complexEventEndTime :: complexEventEndTime()}).
-record( complexEventTimes, {rgr_complexEventTimes_1494 = [#rgr_complexEventTimes_1494{}]}).
-record( rgr_instrumentParties_1018, {instrumentPartyID :: instrumentPartyID(), instrumentPartyIDSource :: instrumentPartyIDSource(), instrumentPartyRole :: instrumentPartyRole(), instrumentPtysSubGrp :: #instrumentPtysSubGrp{}}).
-record( rgr_complexEventDates_1491, {complexEventStartDate :: complexEventStartDate(), complexEventEndDate :: complexEventEndDate(), complexEventTimes :: #complexEventTimes{}}).
-record( tradeReportOrderDetail, {orderID :: orderID(), secondaryOrderID :: secondaryOrderID(), clOrdID :: clOrdID(), secondaryClOrdID :: secondaryClOrdID(), listID :: listID(), refOrderID :: refOrderID(), refOrderIDSource :: refOrderIDSource(), refOrdIDReason :: refOrdIDReason(), ordType :: ordType(), price :: price(), stopPx :: stopPx(), execInst :: execInst(), ordStatus :: ordStatus(), orderQtyData :: #orderQtyData{}, leavesQty :: leavesQty(), cumQty :: cumQty(), timeInForce :: timeInForce(), expireTime :: expireTime(), displayInstruction :: #displayInstruction{}, orderCapacity :: orderCapacity(), orderRestrictions :: orderRestrictions(), bookingType :: bookingType(), origCustOrderCapacity :: origCustOrderCapacity(), orderInputDevice :: orderInputDevice(), lotType :: lotType(), transBkdTime :: transBkdTime(), origOrdModTime :: origOrdModTime()}).
-record( rgr_bidCompRspGrp_420, {commissionData :: #commissionData{}, listID :: listID(), country :: country(), side :: side(), price :: price(), priceType :: priceType(), fairValue :: fairValue(), netGrossInd :: netGrossInd(), settlType :: settlType(), settlDate :: settlDate(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( rgr_undlyInstrumentParties_1058, {underlyingInstrumentPartyID :: underlyingInstrumentPartyID(), underlyingInstrumentPartyIDSource :: underlyingInstrumentPartyIDSource(), underlyingInstrumentPartyRole :: underlyingInstrumentPartyRole(), undlyInstrumentPtysSubGrp :: #undlyInstrumentPtysSubGrp{}}).
-record( rgr_settlParties_781, {settlPartyID :: settlPartyID(), settlPartyIDSource :: settlPartyIDSource(), settlPartyRole :: settlPartyRole(), settlPtysSubGrp :: #settlPtysSubGrp{}}).
...
-record( rgr_parties_453, {partyID :: partyID(), partyIDSource :: partyIDSource(), partyRole :: partyRole(), ptysSubGrp :: #ptysSubGrp{}}).
-record( rgr_nestedParties2_756, {nested2PartyID :: nested2PartyID(), nested2PartyIDSource :: nested2PartyIDSource(), nested2PartyRole :: nested2PartyRole(), nstdPtys2SubGrp :: #nstdPtys2SubGrp{}}).
-record( rgr_nestedParties3_948, {nested3PartyID :: nested3PartyID(), nested3PartyIDSource :: nested3PartyIDSource(), nested3PartyRole :: nested3PartyRole(), nstdPtys3SubGrp :: #nstdPtys3SubGrp{}}).
-record( rgr_derivativeInstrumentParties_1292, {derivativeInstrumentPartyID :: derivativeInstrumentPartyID(), derivativeInstrumentPartyIDSource :: derivativeInstrumentPartyIDSource(), derivativeInstrumentPartyRole :: derivativeInstrumentPartyRole(), derivativeInstrumentPartySubIDsGrp :: #derivativeInstrumentPartySubIDsGrp{}}).
-record( rgr_rootParties_1116, {rootPartyID :: rootPartyID(), rootPartyIDSource :: rootPartyIDSource(), rootPartyRole :: rootPartyRole(), rootSubParties :: #rootSubParties{}}).
...
-record( rgr_strikeRules_1201, {strikeRuleID :: strikeRuleID(), startStrikePxRange :: startStrikePxRange(), endStrikePxRange :: endStrikePxRange(), strikeIncrement :: strikeIncrement(), strikeExerciseStyle :: strikeExerciseStyle(), maturityRules :: #maturityRules{}}).
-record( rgr_nestedParties4_1414, {nested4PartyID :: nested4PartyID(), nested4PartyIDSource :: nested4PartyIDSource(), nested4PartyRole :: nested4PartyRole(), nstdPtys4SubGrp :: #nstdPtys4SubGrp{}}).
...
-record( rgr_nestedParties_539, {nestedPartyID :: nestedPartyID(), nestedPartyIDSource :: nestedPartyIDSource(), nestedPartyRole :: nestedPartyRole(), nstdPtysSubGrp :: #nstdPtysSubGrp{}}).
...
-record( rgr_mDFullGrp_268, {mDEntryType :: mDEntryType(), mDEntryID :: mDEntryID(), mDEntryPx :: mDEntryPx(), priceType :: priceType(), yieldData :: #yieldData{}, spreadOrBenchmarkCurveData :: #spreadOrBenchmarkCurveData{}, ordType :: ordType(), currency :: currency(), settlCurrency :: settlCurrency(), rateSource :: #rateSource{}, mDEntrySize :: mDEntrySize(), secSizesGrp :: #secSizesGrp{}, lotType :: lotType(), mDEntryDate :: mDEntryDate(), mDEntryTime :: mDEntryTime(), tickDirection :: tickDirection(), mDMkt :: mDMkt(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), securityTradingStatus :: securityTradingStatus(), haltReason :: haltReason(), quoteCondition :: quoteCondition(), tradeCondition :: tradeCondition(), mDEntryOriginator :: mDEntryOriginator(), locationID :: locationID(), deskID :: deskID(), openCloseSettlFlag :: openCloseSettlFlag(), timeInForce :: timeInForce(), expireDate :: expireDate(), expireTime :: expireTime(), minQty :: minQty(), execInst :: execInst(), sellerDays :: sellerDays(), orderID :: orderID(), secondaryOrderID :: secondaryOrderID(), quoteEntryID :: quoteEntryID(), mDEntryBuyer :: mDEntryBuyer(), mDEntrySeller :: mDEntrySeller(), numberOfOrders :: numberOfOrders(), mDEntryPositionNo :: mDEntryPositionNo(), scope :: scope(), priceDelta :: priceDelta(), trdType :: trdType(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), mDPriceLevel :: mDPriceLevel(), orderCapacity :: orderCapacity(), mDOriginType :: mDOriginType(), highPx :: highPx(), lowPx :: lowPx(), firstPx :: firstPx(), lastPx :: lastPx(), tradeVolume :: tradeVolume(), settlType :: settlType(), settlDate :: settlDate(), mDQuoteType :: mDQuoteType(), rptSeq :: rptSeq(), dealingCapacity :: dealingCapacity(), mDEntrySpotRate :: mDEntrySpotRate(), mDEntryForwardPoints :: mDEntryForwardPoints(), parties :: #parties{}}).
-record( rgr_complexEvents_1483, {complexEventType :: complexEventType(), complexOptPayoutAmount :: complexOptPayoutAmount(), complexEventPrice :: complexEventPrice(), complexEventPriceBoundaryMethod :: complexEventPriceBoundaryMethod(), complexEventPriceBoundaryPrecision :: complexEventPriceBoundaryPrecision(), complexEventPriceTimeType :: complexEventPriceTimeType(), complexEventCondition :: complexEventCondition(), complexEventDates :: #complexEventDates{}}).
...
-record( instrmtLegIOIGrp, {rgr_instrmtLegIOIGrp_555 = [#rgr_instrmtLegIOIGrp_555{}]}).
-record( rgr_settlDetails_1158, {settlObligSource :: settlObligSource(), settlParties :: #settlParties{}}).
-record( secLstUpdRelSymsLegGrp, {rgr_secLstUpdRelSymsLegGrp_555 = [#rgr_secLstUpdRelSymsLegGrp_555{}]}).
-record( trdSessLstGrp, {rgr_trdSessLstGrp_386 = [#rgr_trdSessLstGrp_386{}]}).
-record( rgr_ordAllocGrp_73, {clOrdID :: clOrdID(), orderID :: orderID(), secondaryOrderID :: secondaryOrderID(), secondaryClOrdID :: secondaryClOrdID(), listID :: listID(), nestedParties2 :: #nestedParties2{}, orderQty :: orderQty(), orderAvgPx :: orderAvgPx(), orderBookingQty :: orderBookingQty()}).
-record( rgr_positionQty_702, {posType :: posType(), longQty :: longQty(), shortQty :: shortQty(), posQtyStatus :: posQtyStatus(), quantityDate :: quantityDate(), nestedParties :: #nestedParties{}}).
-record( rgr_applIDRequestGrp_1351, {refApplID :: refApplID(), refApplReqID :: refApplReqID(), applBegSeqNum :: applBegSeqNum(), applEndSeqNum :: applEndSeqNum(), nestedParties :: #nestedParties{}}).
...
-record( rgr_fillsGrp_1362, {fillExecID :: fillExecID(), fillPx :: fillPx(), fillQty :: fillQty(), fillLiquidityInd :: fillLiquidityInd(), nestedParties4 :: #nestedParties4{}}).
-record( tradeCapLegUnderlyingsGrp, {rgr_tradeCapLegUnderlyingsGrp_1342 = [#rgr_tradeCapLegUnderlyingsGrp_1342{}]}).
-record( rgr_applIDRequestAckGrp_1351, {refApplID :: refApplID(), refApplReqID :: refApplReqID(), applBegSeqNum :: applBegSeqNum(), applEndSeqNum :: applEndSeqNum(), refApplLastSeqNum :: refApplLastSeqNum(), applResponseError :: applResponseError(), nestedParties :: #nestedParties{}}).
...
-record( rgr_legQuotStatGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legOrderQty :: legOrderQty(), legSwapType :: legSwapType(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legStipulations :: #legStipulations{}, nestedParties :: #nestedParties{}}).
-record( rgr_preAllocGrp_78, {allocAccount :: allocAccount(), allocAcctIDSource :: allocAcctIDSource(), allocSettlCurrency :: allocSettlCurrency(), individualAllocID :: individualAllocID(), nestedParties :: #nestedParties{}, allocQty :: allocQty()}).
-record( rgr_quotReqLegsGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legOrderQty :: legOrderQty(), legSwapType :: legSwapType(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legStipulations :: #legStipulations{}, nestedParties :: #nestedParties{}, legBenchmarkCurveData :: #legBenchmarkCurveData{}, legRefID :: legRefID()}).
-record( fillsGrp, {rgr_fillsGrp_1362 = [#rgr_fillsGrp_1362{}]}).
-record( rgr_posUndInstrmtGrp_711, {underlyingInstrument :: #underlyingInstrument{}, underlyingSettlPrice :: underlyingSettlPrice(), underlyingSettlPriceType :: underlyingSettlPriceType(), underlyingDeliveryAmount :: underlyingDeliveryAmount(), underlyingAmount :: #underlyingAmount{}}).
-record( applIDRequestAckGrp, {rgr_applIDRequestAckGrp_1351 = [#rgr_applIDRequestAckGrp_1351{}]}).
-record( rgr_undInstrmtCollGrp_711, {underlyingInstrument :: #underlyingInstrument{}, collAction :: collAction()}).
-record( quotReqLegsGrp, {rgr_quotReqLegsGrp_555 = [#rgr_quotReqLegsGrp_555{}]}).
-record( dlvyInstGrp, {rgr_dlvyInstGrp_85 = [#rgr_dlvyInstGrp_85{}]}).
-record( preAllocGrp, {rgr_preAllocGrp_78 = [#rgr_preAllocGrp_78{}]}).
-record( positionQty, {rgr_positionQty_702 = [#rgr_positionQty_702{}]}).
-record( settlDetails, {rgr_settlDetails_1158 = [#rgr_settlDetails_1158{}]}).
-record( sideCrossOrdCxlGrp, {rgr_sideCrossOrdCxlGrp_552 = [#rgr_sideCrossOrdCxlGrp_552{}]}).
-record( rgr_undInstrmtGrp_711, {underlyingInstrument :: #underlyingInstrument{}}).
-record( rgstDtlsGrp, {rgr_rgstDtlsGrp_473 = [#rgr_rgstDtlsGrp_473{}]}).
-record( trdAllocGrp, {rgr_trdAllocGrp_78 = [#rgr_trdAllocGrp_78{}]}).
-record( applIDRequestGrp, {rgr_applIDRequestGrp_1351 = [#rgr_applIDRequestGrp_1351{}]}).
-record( rgr_trdInstrmtLegGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legReportID :: legReportID(), legNumber :: legNumber(), legStipulations :: #legStipulations{}, legPositionEffect :: legPositionEffect(), legCoveredOrUncovered :: legCoveredOrUncovered(), nestedParties :: #nestedParties{}, legRefID :: legRefID(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legLastPx :: legLastPx(), legSettlCurrency :: legSettlCurrency(), legLastForwardPoints :: legLastForwardPoints(), legCalculatedCcyLastQty :: legCalculatedCcyLastQty(), legGrossTradeAmt :: legGrossTradeAmt(), legVolatility :: legVolatility(), legDividendYield :: legDividendYield(), legCurrencyRatio :: legCurrencyRatio(), legExecInst :: legExecInst(), legLastQty :: legLastQty(), tradeCapLegUnderlyingsGrp :: #tradeCapLegUnderlyingsGrp{}}).
-record( ordAllocGrp, {rgr_ordAllocGrp_73 = [#rgr_ordAllocGrp_73{}]}).
-record( allocAckGrp, {rgr_allocAckGrp_78 = [#rgr_allocAckGrp_78{}]}).
-record( legQuotStatGrp, {rgr_legQuotStatGrp_555 = [#rgr_legQuotStatGrp_555{}]}).
-record( preAllocMlegGrp, {rgr_preAllocMlegGrp_78 = [#rgr_preAllocMlegGrp_78{}]}).
-record( legQuotGrp, {rgr_legQuotGrp_555 = [#rgr_legQuotGrp_555{}]}).
-record( mDFullGrp, {rgr_mDFullGrp_268 = [#rgr_mDFullGrp_268{}]}).
-record( legPreAllocGrp, {rgr_legPreAllocGrp_670 = [#rgr_legPreAllocGrp_670{}]}).
-record( complexEvents, {rgr_complexEvents_1483 = [#rgr_complexEvents_1483{}]}).
...
-record( rgr_quotReqGrp_146, {instrument :: #instrument{}, financingDetails :: #financingDetails{}, undInstrmtGrp :: #undInstrmtGrp{}, prevClosePx :: prevClosePx(), quoteRequestType :: quoteRequestType(), quoteType :: quoteType(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), tradeOriginationDate :: tradeOriginationDate(), side :: side(), qtyType :: qtyType(), orderQtyData :: #orderQtyData{}, minQty :: minQty(), settlType :: settlType(), settlDate :: settlDate(), settlDate2 :: settlDate2(), orderQty2 :: orderQty2(), currency :: currency(), settlCurrency :: settlCurrency(), rateSource :: #rateSource{}, stipulations :: #stipulations{}, account :: account(), acctIDSource :: acctIDSource(), accountType :: accountType(), quotReqLegsGrp :: #quotReqLegsGrp{}, quotQualGrp :: #quotQualGrp{}, quotePriceType :: quotePriceType(), ordType :: ordType(), validUntilTime :: validUntilTime(), expireTime :: expireTime(), transactTime :: transactTime(), spreadOrBenchmarkCurveData :: #spreadOrBenchmarkCurveData{}, priceType :: priceType(), price :: price(), price2 :: price2(), yieldData :: #yieldData{}, parties :: #parties{}}).
-record( instrmtLegExecGrp, {rgr_instrmtLegExecGrp_555 = [#rgr_instrmtLegExecGrp_555{}]}).
-record( rgr_quotReqRjctGrp_146, {instrument :: #instrument{}, financingDetails :: #financingDetails{}, undInstrmtGrp :: #undInstrmtGrp{}, prevClosePx :: prevClosePx(), quoteRequestType :: quoteRequestType(), quoteType :: quoteType(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), tradeOriginationDate :: tradeOriginationDate(), side :: side(), qtyType :: qtyType(), orderQtyData :: #orderQtyData{}, settlType :: settlType(), settlDate :: settlDate(), settlDate2 :: settlDate2(), orderQty2 :: orderQty2(), currency :: currency(), stipulations :: #stipulations{}, account :: account(), acctIDSource :: acctIDSource(), accountType :: accountType(), quotReqLegsGrp :: #quotReqLegsGrp{}, quotQualGrp :: #quotQualGrp{}, quotePriceType :: quotePriceType(), ordType :: ordType(), expireTime :: expireTime(), transactTime :: transactTime(), spreadOrBenchmarkCurveData :: #spreadOrBenchmarkCurveData{}, priceType :: priceType(), price :: price(), price2 :: price2(), yieldData :: #yieldData{}, parties :: #parties{}}).
-record( rgr_quotCxlEntriesGrp_295, {instrument :: #instrument{}, financingDetails :: #financingDetails{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}}).
-record( rgr_listOrdGrp_73, {clOrdID :: clOrdID(), secondaryClOrdID :: secondaryClOrdID(), listSeqNo :: listSeqNo(), clOrdLinkID :: clOrdLinkID(), settlInstMode :: settlInstMode(), parties :: #parties{}, tradeOriginationDate :: tradeOriginationDate(), tradeDate :: tradeDate(), account :: account(), acctIDSource :: acctIDSource(), accountType :: accountType(), dayBookingInst :: dayBookingInst(), bookingUnit :: bookingUnit(), allocID :: allocID(), preallocMethod :: preallocMethod(), preAllocGrp :: #preAllocGrp{}, settlType :: settlType(), settlDate :: settlDate(), cashMargin :: cashMargin(), clearingFeeIndicator :: clearingFeeIndicator(), handlInst :: handlInst(), execInst :: execInst(), minQty :: minQty(), matchIncrement :: matchIncrement(), maxPriceLevels :: maxPriceLevels(), displayInstruction :: #displayInstruction{}, maxFloor :: maxFloor(), exDestination :: exDestination(), exDestinationIDSource :: exDestinationIDSource(), trdgSesGrp :: #trdgSesGrp{}, processCode :: processCode(), instrument :: #instrument{}, undInstrmtGrp :: #undInstrmtGrp{}, prevClosePx :: prevClosePx(), side :: side(), sideValueInd :: sideValueInd(), locateReqd :: locateReqd(), transactTime :: transactTime(), stipulations :: #stipulations{}, qtyType :: qtyType(), orderQtyData :: #orderQtyData{}, ordType :: ordType(), priceType :: priceType(), price :: price(), priceProtectionScope :: priceProtectionScope(), stopPx :: stopPx(), triggeringInstruction :: #triggeringInstruction{}, spreadOrBenchmarkCurveData :: #spreadOrBenchmarkCurveData{}, yieldData :: #yieldData{}, currency :: currency(), complianceID :: complianceID(), solicitedFlag :: solicitedFlag(), iOIID :: iOIID(), quoteID :: quoteID(), refOrderID :: refOrderID(), refOrderIDSource :: refOrderIDSource(), timeInForce :: timeInForce(), effectiveTime :: effectiveTime(), expireDate :: expireDate(), expireTime :: expireTime(), gTBookingInst :: gTBookingInst(), commissionData :: #commissionData{}, orderCapacity :: orderCapacity(), orderRestrictions :: orderRestrictions(), preTradeAnonymity :: preTradeAnonymity(), custOrderCapacity :: custOrderCapacity(), forexReq :: forexReq(), settlCurrency :: settlCurrency(), bookingType :: bookingType(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), settlDate2 :: settlDate2(), orderQty2 :: orderQty2(), price2 :: price2(), positionEffect :: positionEffect(), coveredOrUncovered :: coveredOrUncovered(), maxShow :: maxShow(), pegInstructions :: #pegInstructions{}, discretionInstructions :: #discretionInstructions{}, targetStrategy :: targetStrategy(), strategyParametersGrp :: #strategyParametersGrp{}, targetStrategyParameters :: targetStrategyParameters(), participationRate :: participationRate(), designation :: designation()}).
-record( rgr_secLstUpdRelSymGrp_146, {listUpdateAction :: listUpdateAction(), instrument :: #instrument{}, instrumentExtension :: #instrumentExtension{}, financingDetails :: #financingDetails{}, securityTradingRules :: #securityTradingRules{}, strikeRules :: #strikeRules{}, undInstrmtGrp :: #undInstrmtGrp{}, currency :: currency(), stipulations :: #stipulations{}, secLstUpdRelSymsLegGrp :: #secLstUpdRelSymsLegGrp{}, spreadOrBenchmarkCurveData :: #spreadOrBenchmarkCurveData{}, yieldData :: #yieldData{}, relSymTransactTime :: relSymTransactTime(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( sideCrossOrdModGrp, {rgr_sideCrossOrdModGrp_552 = [#rgr_sideCrossOrdModGrp_552{}]}).
-record( rgr_quotEntryAckGrp_295, {quoteEntryID :: quoteEntryID(), instrument :: #instrument{}, instrmtLegGrp :: #instrmtLegGrp{}, bidPx :: bidPx(), offerPx :: offerPx(), bidSize :: bidSize(), offerSize :: offerSize(), validUntilTime :: validUntilTime(), bidSpotRate :: bidSpotRate(), offerSpotRate :: offerSpotRate(), bidForwardPoints :: bidForwardPoints(), offerForwardPoints :: offerForwardPoints(), midPx :: midPx(), bidYield :: bidYield(), midYield :: midYield(), offerYield :: offerYield(), transactTime :: transactTime(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), settlDate :: settlDate(), ordType :: ordType(), settlDate2 :: settlDate2(), orderQty2 :: orderQty2(), bidForwardPoints2 :: bidForwardPoints2(), offerForwardPoints2 :: offerForwardPoints2(), currency :: currency(), bookingType :: bookingType(), orderCapacity :: orderCapacity(), orderRestrictions :: orderRestrictions(), quoteEntryStatus :: quoteEntryStatus(), quoteEntryRejectReason :: quoteEntryRejectReason()}).
-record( rgr_strmAsgnReqInstrmtGrp_146, {instrument :: #instrument{}, settlType :: settlType(), mDEntrySize :: mDEntrySize(), mDStreamID :: mDStreamID()}).
-record( legOrdGrp, {rgr_legOrdGrp_555 = [#rgr_legOrdGrp_555{}]}).
-record( rgr_relSymDerivSecGrp_146, {instrument :: #instrument{}, secondaryPriceLimits :: #secondaryPriceLimits{}, currency :: currency(), corporateAction :: corporateAction(), instrumentExtension :: #instrumentExtension{}, instrmtLegGrp :: #instrmtLegGrp{}, relSymTransactTime :: relSymTransactTime(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( rgr_relSymDerivSecUpdGrp_146, {listUpdateAction :: listUpdateAction(), corporateAction :: corporateAction(), instrument :: #instrument{}, instrumentExtension :: #instrumentExtension{}, secondaryPriceLimits :: #secondaryPriceLimits{}, currency :: currency(), instrmtLegGrp :: #instrmtLegGrp{}, relSymTransactTime :: relSymTransactTime(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( rgr_mDIncGrp_268, {mDUpdateAction :: mDUpdateAction(), deleteReason :: deleteReason(), mDSubBookType :: mDSubBookType(), marketDepth :: marketDepth(), mDEntryType :: mDEntryType(), mDEntryID :: mDEntryID(), mDEntryRefID :: mDEntryRefID(), mDStreamID :: mDStreamID(), instrument :: #instrument{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}, financialStatus :: financialStatus(), corporateAction :: corporateAction(), mDEntryPx :: mDEntryPx(), priceType :: priceType(), yieldData :: #yieldData{}, spreadOrBenchmarkCurveData :: #spreadOrBenchmarkCurveData{}, ordType :: ordType(), currency :: currency(), settlCurrency :: settlCurrency(), rateSource :: #rateSource{}, mDEntrySize :: mDEntrySize(), secSizesGrp :: #secSizesGrp{}, lotType :: lotType(), mDEntryDate :: mDEntryDate(), mDEntryTime :: mDEntryTime(), tickDirection :: tickDirection(), mDMkt :: mDMkt(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), securityTradingStatus :: securityTradingStatus(), haltReason :: haltReason(), quoteCondition :: quoteCondition(), tradeCondition :: tradeCondition(), trdType :: trdType(), matchType :: matchType(), mDEntryOriginator :: mDEntryOriginator(), locationID :: locationID(), deskID :: deskID(), openCloseSettlFlag :: openCloseSettlFlag(), timeInForce :: timeInForce(), expireDate :: expireDate(), expireTime :: expireTime(), minQty :: minQty(), execInst :: execInst(), sellerDays :: sellerDays(), orderID :: orderID(), secondaryOrderID :: secondaryOrderID(), quoteEntryID :: quoteEntryID(), tradeID :: tradeID(), mDEntryBuyer :: mDEntryBuyer(), mDEntrySeller :: mDEntrySeller(), numberOfOrders :: numberOfOrders(), mDEntryPositionNo :: mDEntryPositionNo(), scope :: scope(), priceDelta :: priceDelta(), netChgPrevDay :: netChgPrevDay(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), mDPriceLevel :: mDPriceLevel(), orderCapacity :: orderCapacity(), mDOriginType :: mDOriginType(), highPx :: highPx(), lowPx :: lowPx(), firstPx :: firstPx(), lastPx :: lastPx(), tradeVolume :: tradeVolume(), settlType :: settlType(), settlDate :: settlDate(), transBkdTime :: transBkdTime(), transactTime :: transactTime(), mDQuoteType :: mDQuoteType(), rptSeq :: rptSeq(), dealingCapacity :: dealingCapacity(), mDEntrySpotRate :: mDEntrySpotRate(), mDEntryForwardPoints :: mDEntryForwardPoints(), statsIndGrp :: #statsIndGrp{}, parties :: #parties{}}).
-record( rgr_strmAsgnRptInstrmtGrp_146, {instrument :: #instrument{}, settlType :: settlType(), streamAsgnType :: streamAsgnType(), mDStreamID :: mDStreamID(), streamAsgnRejReason :: streamAsgnRejReason(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( rgr_allocGrp_78, {allocAccount :: allocAccount(), allocAcctIDSource :: allocAcctIDSource(), matchStatus :: matchStatus(), allocPrice :: allocPrice(), allocQty :: allocQty(), individualAllocID :: individualAllocID(), processCode :: processCode(), secondaryIndividualAllocID :: secondaryIndividualAllocID(), allocMethod :: allocMethod(), allocCustomerCapacity :: allocCustomerCapacity(), allocPositionEffect :: allocPositionEffect(), individualAllocType :: individualAllocType(), nestedParties :: #nestedParties{}, notifyBrokerOfCredit :: notifyBrokerOfCredit(), allocHandlInst :: allocHandlInst(), allocText :: allocText(), encodedAllocTextLen :: encodedAllocTextLen(), encodedAllocText :: encodedAllocText(), commissionData :: #commissionData{}, allocAvgPx :: allocAvgPx(), allocNetMoney :: allocNetMoney(), settlCurrAmt :: settlCurrAmt(), allocSettlCurrAmt :: allocSettlCurrAmt(), settlCurrency :: settlCurrency(), allocSettlCurrency :: allocSettlCurrency(), settlCurrFxRate :: settlCurrFxRate(), settlCurrFxRateCalc :: settlCurrFxRateCalc(), allocAccruedInterestAmt :: allocAccruedInterestAmt(), allocInterestAtMaturity :: allocInterestAtMaturity(), miscFeesGrp :: #miscFeesGrp{}, clrInstGrp :: #clrInstGrp{}, clearingFeeIndicator :: clearingFeeIndicator(), allocSettlInstType :: allocSettlInstType(), settlInstructionsData :: #settlInstructionsData{}}).
-record( rgr_instrmtStrkPxGrp_428, {instrument :: #instrument{}, undInstrmtGrp :: #undInstrmtGrp{}, prevClosePx :: prevClosePx(), clOrdID :: clOrdID(), secondaryClOrdID :: secondaryClOrdID(), side :: side(), price :: price(), currency :: currency(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( trdCapRptSideGrp, {rgr_trdCapRptSideGrp_552 = [#rgr_trdCapRptSideGrp_552{}]}).
-record( rgr_instrmtGrp_146, {instrument :: #instrument{}}).
-record( rgr_secListGrp_146, {instrument :: #instrument{}, instrumentExtension :: #instrumentExtension{}, financingDetails :: #financingDetails{}, securityTradingRules :: #securityTradingRules{}, strikeRules :: #strikeRules{}, undInstrmtGrp :: #undInstrmtGrp{}, currency :: currency(), stipulations :: #stipulations{}, instrmtLegSecListGrp :: #instrmtLegSecListGrp{}, spreadOrBenchmarkCurveData :: #spreadOrBenchmarkCurveData{}, yieldData :: #yieldData{}, relSymTransactTime :: relSymTransactTime(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( rgr_rFQReqGrp_146, {instrument :: #instrument{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}, prevClosePx :: prevClosePx(), quoteRequestType :: quoteRequestType(), quoteType :: quoteType(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID()}).
-record( rgr_settlObligationInstructions_1165, {netGrossInd :: netGrossInd(), settlObligID :: settlObligID(), settlObligTransType :: settlObligTransType(), settlObligRefID :: settlObligRefID(), ccyAmt :: ccyAmt(), settlCurrAmt :: settlCurrAmt(), currency :: currency(), settlCurrency :: settlCurrency(), settlCurrFxRate :: settlCurrFxRate(), settlDate :: settlDate(), instrument :: #instrument{}, parties :: #parties{}, effectiveTime :: effectiveTime(), expireTime :: expireTime(), lastUpdateTime :: lastUpdateTime(), settlDetails :: #settlDetails{}}).
-record( trdCapRptAckSideGrp, {rgr_trdCapRptAckSideGrp_552 = [#rgr_trdCapRptAckSideGrp_552{}]}).
-record( rgr_instrmtMDReqGrp_146, {instrument :: #instrument{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}, currency :: currency(), quoteType :: quoteType(), settlType :: settlType(), settlDate :: settlDate(), mDEntrySize :: mDEntrySize(), mDStreamID :: mDStreamID()}).
-record( rgr_settlInstGrp_778, {settlInstID :: settlInstID(), settlInstTransType :: settlInstTransType(), settlInstRefID :: settlInstRefID(), parties :: #parties{}, side :: side(), produkt :: produkt(), securityType :: securityType(), cFICode :: cFICode(), settlCurrency :: settlCurrency(), effectiveTime :: effectiveTime(), expireTime :: expireTime(), lastUpdateTime :: lastUpdateTime(), settlInstructionsData :: #settlInstructionsData{}, paymentMethod :: paymentMethod(), paymentRef :: paymentRef(), cardHolderName :: cardHolderName(), cardNumber :: cardNumber(), cardStartDate :: cardStartDate(), cardExpDate :: cardExpDate(), cardIssNum :: cardIssNum(), paymentDate :: paymentDate(), paymentRemitterID :: paymentRemitterID()}).
-record( marketSegmentGrp, {rgr_marketSegmentGrp_1310 = [#rgr_marketSegmentGrp_1310{}]}).
-record( strmAsgnRptInstrmtGrp, {rgr_strmAsgnRptInstrmtGrp_146 = [#rgr_strmAsgnRptInstrmtGrp_146{}]}).
-record( relSymDerivSecUpdGrp, {rgr_relSymDerivSecUpdGrp_146 = [#rgr_relSymDerivSecUpdGrp_146{}]}).
-record( quotCxlEntriesGrp, {rgr_quotCxlEntriesGrp_295 = [#rgr_quotCxlEntriesGrp_295{}]}).
-record( quotReqRjctGrp, {rgr_quotReqRjctGrp_146 = [#rgr_quotReqRjctGrp_146{}]}).
-record( listOrdGrp, {rgr_listOrdGrp_73 = [#rgr_listOrdGrp_73{}]}).
-record( instrmtMDReqGrp, {rgr_instrmtMDReqGrp_146 = [#rgr_instrmtMDReqGrp_146{}]}).
-record( relSymDerivSecGrp, {rgr_relSymDerivSecGrp_146 = [#rgr_relSymDerivSecGrp_146{}]}).
-record( settlInstGrp, {rgr_settlInstGrp_778 = [#rgr_settlInstGrp_778{}]}).
-record( secLstUpdRelSymGrp, {rgr_secLstUpdRelSymGrp_146 = [#rgr_secLstUpdRelSymGrp_146{}]}).
-record( strmAsgnReqInstrmtGrp, {rgr_strmAsgnReqInstrmtGrp_146 = [#rgr_strmAsgnReqInstrmtGrp_146{}]}).
-record( mDIncGrp, {rgr_mDIncGrp_268 = [#rgr_mDIncGrp_268{}]}).
-record( settlObligationInstructions, {rgr_settlObligationInstructions_1165 = [#rgr_settlObligationInstructions_1165{}]}).
-record( instrmtStrkPxGrp, {rgr_instrmtStrkPxGrp_428 = [#rgr_instrmtStrkPxGrp_428{}]}).
-record( instrmtGrp, {rgr_instrmtGrp_146 = [#rgr_instrmtGrp_146{}]}).
-record( quotEntryGrp, {rgr_quotEntryGrp_295 = [#rgr_quotEntryGrp_295{}]}).
-record( quotEntryAckGrp, {rgr_quotEntryAckGrp_295 = [#rgr_quotEntryAckGrp_295{}]}).
-record( allocGrp, {rgr_allocGrp_78 = [#rgr_allocGrp_78{}]}).
-record( secListGrp, {rgr_secListGrp_146 = [#rgr_secListGrp_146{}]}).
...
-record( rFQReqGrp, {rgr_rFQReqGrp_146 = [#rgr_rFQReqGrp_146{}]}).
-record( quotReqGrp, {rgr_quotReqGrp_146 = [#rgr_quotReqGrp_146{}]}).
-record( rgr_strmAsgnReqGrp_1499, {parties :: #parties{}, strmAsgnReqInstrmtGrp :: #strmAsgnReqInstrmtGrp{}}).
-record( rgr_quotSetGrp_296, {quoteSetID :: quoteSetID(), underlyingInstrument :: #underlyingInstrument{}, quoteSetValidUntilTime :: quoteSetValidUntilTime(), totNoQuoteEntries :: totNoQuoteEntries(), lastFragment :: lastFragment(), quotEntryGrp :: #quotEntryGrp{}}).
-record( rgr_quotSetAckGrp_296, {quoteSetID :: quoteSetID(), underlyingInstrument :: #underlyingInstrument{}, quoteSetValidUntilTime :: quoteSetValidUntilTime(), totNoQuoteEntries :: totNoQuoteEntries(), totNoCxldQuotes :: totNoCxldQuotes(), totNoAccQuotes :: totNoAccQuotes(), totNoRejQuotes :: totNoRejQuotes(), lastFragment :: lastFragment(), quotEntryAckGrp :: #quotEntryAckGrp{}}).
-record( rgr_strmAsgnRptGrp_1499, {parties :: #parties{}, strmAsgnRptInstrmtGrp :: #strmAsgnRptInstrmtGrp{}}).
-record( strmAsgnRptGrp, {rgr_strmAsgnRptGrp_1499 = [#rgr_strmAsgnRptGrp_1499{}]}).
-record( quotSetAckGrp, {rgr_quotSetAckGrp_296 = [#rgr_quotSetAckGrp_296{}]}).
-record( quotSetGrp, {rgr_quotSetGrp_296 = [#rgr_quotSetGrp_296{}]}).
-record( strmAsgnReqGrp, {rgr_strmAsgnReqGrp_1499 = [#rgr_strmAsgnReqGrp_1499{}]}).
...
-record( news, {standardHeader :: #standardHeader{}, applicationSequenceControl :: #applicationSequenceControl{}, newsID :: newsID(), newsRefGrp :: #newsRefGrp{}, newsCategory :: newsCategory(), languageCode :: languageCode(), origTime :: origTime(), urgency :: urgency(), headline :: headline(), encodedHeadlineLen :: encodedHeadlineLen(), encodedHeadline :: encodedHeadline(), routingGrp :: #routingGrp{}, marketID :: marketID(), marketSegmentID :: marketSegmentID(), instrmtGrp :: #instrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}, undInstrmtGrp :: #undInstrmtGrp{}, linesOfTextGrp :: #linesOfTextGrp{}, uRLLink :: uRLLink(), rawDataLength :: rawDataLength(), rawData :: rawData(), standardTrailer :: #standardTrailer{}}).
...
-record( quoteCancel, {standardHeader :: #standardHeader{}, quoteReqID :: quoteReqID(), quoteID :: quoteID(), quoteMsgID :: quoteMsgID(), quoteCancelType :: quoteCancelType(), quoteType :: quoteType(), quoteResponseLevel :: quoteResponseLevel(), parties :: #parties{}, targetParties :: #targetParties{}, account :: account(), acctIDSource :: acctIDSource(), accountType :: accountType(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), quotCxlEntriesGrp :: #quotCxlEntriesGrp{}, standardTrailer :: #standardTrailer{}}).
-record( quoteStatusRequest, {standardHeader :: #standardHeader{}, quoteStatusReqID :: quoteStatusReqID(), quoteID :: quoteID(), instrument :: #instrument{}, financingDetails :: #financingDetails{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}, parties :: #parties{}, targetParties :: #targetParties{}, account :: account(), acctIDSource :: acctIDSource(), accountType :: accountType(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), subscriptionRequestType :: subscriptionRequestType(), standardTrailer :: #standardTrailer{}}).
-record( massQuoteAcknowledgement, {standardHeader :: #standardHeader{}, quoteReqID :: quoteReqID(), quoteID :: quoteID(), quoteStatus :: quoteStatus(), quoteRejectReason :: quoteRejectReason(), quoteResponseLevel :: quoteResponseLevel(), quoteType :: quoteType(), quoteCancelType :: quoteCancelType(), parties :: #parties{}, targetParties :: #targetParties{}, account :: account(), acctIDSource :: acctIDSource(), accountType :: accountType(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), quotSetAckGrp :: #quotSetAckGrp{}, standardTrailer :: #standardTrailer{}}).
...
-record( securityListRequest, {standardHeader :: #standardHeader{}, securityReqID :: securityReqID(), securityListRequestType :: securityListRequestType(), securityListID :: securityListID(), securityListType :: securityListType(), securityListTypeSource :: securityListTypeSource(), marketID :: marketID(), marketSegmentID :: marketSegmentID(), instrument :: #instrument{}, instrumentExtension :: #instrumentExtension{}, financingDetails :: #financingDetails{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}, currency :: currency(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), tradingSessionID :: tradingSessionID(), tradingSessionSubID :: tradingSessionSubID(), subscriptionRequestType :: subscriptionRequestType(), standardTrailer :: #standardTrailer{}}).
-record( securityList, {standardHeader :: #standardHeader{}, applicationSequenceControl :: #applicationSequenceControl{}, securityReportID :: securityReportID(), clearingBusinessDate :: clearingBusinessDate(), securityListID :: securityListID(), securityListRefID :: securityListRefID(), securityListDesc :: securityListDesc(), encodedSecurityListDescLen :: encodedSecurityListDescLen(), encodedSecurityListDesc :: encodedSecurityListDesc(), securityListType :: securityListType(), securityListTypeSource :: securityListTypeSource(), securityReqID :: securityReqID(), securityResponseID :: securityResponseID(), securityRequestResult :: securityRequestResult(), transactTime :: transactTime(), totNoRelatedSym :: totNoRelatedSym(), marketID :: marketID(), marketSegmentID :: marketSegmentID(), lastFragment :: lastFragment(), secListGrp :: #secListGrp{}, standardTrailer :: #standardTrailer{}}).
...
-record( derivativeSecurityList, {standardHeader :: #standardHeader{}, applicationSequenceControl :: #applicationSequenceControl{}, securityReportID :: securityReportID(), securityReqID :: securityReqID(), securityResponseID :: securityResponseID(), securityRequestResult :: securityRequestResult(), clearingBusinessDate :: clearingBusinessDate(), underlyingInstrument :: #underlyingInstrument{}, derivativeSecurityDefinition :: #derivativeSecurityDefinition{}, transactTime :: transactTime(), totNoRelatedSym :: totNoRelatedSym(), lastFragment :: lastFragment(), relSymDerivSecGrp :: #relSymDerivSecGrp{}, standardTrailer :: #standardTrailer{}}).
...
-record( securityListUpdateReport, {standardHeader :: #standardHeader{}, applicationSequenceControl :: #applicationSequenceControl{}, securityReportID :: securityReportID(), securityListID :: securityListID(), securityListRefID :: securityListRefID(), securityListDesc :: securityListDesc(), encodedSecurityListDescLen :: encodedSecurityListDescLen(), encodedSecurityListDesc :: encodedSecurityListDesc(), securityListType :: securityListType(), securityListTypeSource :: securityListTypeSource(), securityReqID :: securityReqID(), securityResponseID :: securityResponseID(), securityRequestResult :: securityRequestResult(), totNoRelatedSym :: totNoRelatedSym(), clearingBusinessDate :: clearingBusinessDate(), securityUpdateAction :: securityUpdateAction(), corporateAction :: corporateAction(), marketID :: marketID(), marketSegmentID :: marketSegmentID(), transactTime :: transactTime(), lastFragment :: lastFragment(), secLstUpdRelSymGrp :: #secLstUpdRelSymGrp{}, standardTrailer :: #standardTrailer{}}).
...
-record( derivativeSecurityListUpdateReport, {standardHeader :: #standardHeader{}, applicationSequenceControl :: #applicationSequenceControl{}, securityReqID :: securityReqID(), securityResponseID :: securityResponseID(), securityRequestResult :: securityRequestResult(), securityUpdateAction :: securityUpdateAction(), underlyingInstrument :: #underlyingInstrument{}, derivativeSecurityDefinition :: #derivativeSecurityDefinition{}, transactTime :: transactTime(), totNoRelatedSym :: totNoRelatedSym(), lastFragment :: lastFragment(), relSymDerivSecUpdGrp :: #relSymDerivSecUpdGrp{}, standardTrailer :: #standardTrailer{}}).
-record( tradingSessionListUpdateReport, {standardHeader :: #standardHeader{}, applicationSequenceControl :: #applicationSequenceControl{}, tradSesReqID :: tradSesReqID(), trdSessLstGrp :: #trdSessLstGrp{}, standardTrailer :: #standardTrailer{}}).
...
-record( applicationMessageRequest, {standardHeader :: #standardHeader{}, applReqID :: applReqID(), applReqType :: applReqType(), applIDRequestGrp :: #applIDRequestGrp{}, parties :: #parties{}, text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText(), standardTrailer :: #standardTrailer{}}).
