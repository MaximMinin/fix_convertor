%% @author Maxim Minin 
%% @doc @todo Add description to fix_5_0_sp1_convertor_proper_test.
-module(fix_5_0_sp1_convertor_proper_test). 

%%       
%% Include files  
%%
-include_lib("proper/include/proper.hrl").   
-include("FIX_5_0SP1.hrl").      

-compile([{no_auto_import, [date/0, time/0]}, 
          {parse_transform, a_generator_transform}, 
          export_all, debug_info]). 
 
-define(FIXVERSION, 'FIX 5.0 SP 1').
