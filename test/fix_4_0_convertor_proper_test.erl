%% @author Maxim Minin 
%% @doc @todo Add description to fix_4_0_convertor_proper_test.
-module(fix_4_0_convertor_proper_test). 
...
%% ====================================================================
%% proper:quickcheck(fix_4_0_convertor_proper_test:prop_convertor()).
%% ====================================================================
prop_convertor() ->
