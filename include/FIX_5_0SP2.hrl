...
-record( repeatingReg_secTypesGrp_558, {securityType :: securityType(), securitySubType :: securitySubType(), produkt :: produkt(), cFICode :: cFICode(), transactTime :: transactTime()}).
...
-record( repeatingReg_undlyInstrumentPtysSubGrp_1062, {underlyingInstrumentPartySubID :: underlyingInstrumentPartySubID(), underlyingInstrumentPartySubIDType :: underlyingInstrumentPartySubIDType()}).
...
-record( repeatingReg_rateSource_1445, {rateSource :: rateSource(), rateSourceType :: rateSourceType(), referencePage :: referencePage()}).
-record( rateSource, {repeatingReg_rateSource_1445 = [#repeatingReg_rateSource_1445{}]}).
-record( repeatingReg_targetParties_1461, {targetPartyID :: targetPartyID(), targetPartyIDSource :: targetPartyIDSource(), targetPartyRole :: targetPartyRole()}).
-record( targetParties, {repeatingReg_targetParties_1461 = [#repeatingReg_targetParties_1461{}]}).
-record( repeatingReg_newsRefGrp_1475, {newsRefID :: newsRefID(), newsRefType :: newsRefType()}).
-record( newsRefGrp, {repeatingReg_newsRefGrp_1475 = [#repeatingReg_newsRefGrp_1475{}]}).
-record( repeatingReg_complexEventTimes_1494, {complexEventStartTime :: complexEventStartTime(), complexEventEndTime :: complexEventEndTime()}).
-record( complexEventTimes, {repeatingReg_complexEventTimes_1494 = [#repeatingReg_complexEventTimes_1494{}]}).
-record( repeatingReg_complexEventDates_1491, {complexEventStartDate :: complexEventStartDate(), complexEventEndDate :: complexEventEndDate(), complexEventTimes :: #complexEventTimes{}}).
...
-record( repeatingReg_undlyInstrumentParties_1058, {underlyingInstrumentPartyID :: underlyingInstrumentPartyID(), underlyingInstrumentPartyIDSource :: underlyingInstrumentPartyIDSource(), underlyingInstrumentPartyRole :: underlyingInstrumentPartyRole(), undlyInstrumentPtysSubGrp :: #undlyInstrumentPtysSubGrp{}}).
...
-record( complexEventDates, {repeatingReg_complexEventDates_1491 = [#repeatingReg_complexEventDates_1491{}]}).
...
-record( repeatingReg_fillsGrp_1362, {fillExecID :: fillExecID(), fillPx :: fillPx(), fillQty :: fillQty(), fillLiquidityInd :: fillLiquidityInd(), nestedParties4 :: #nestedParties4{}}).
...
-record( repeatingReg_applIDRequestAckGrp_1351, {refApplID :: refApplID(), refApplReqID :: refApplReqID(), applBegSeqNum :: applBegSeqNum(), applEndSeqNum :: applEndSeqNum(), refApplLastSeqNum :: refApplLastSeqNum(), applResponseError :: applResponseError(), nestedParties :: #nestedParties{}}).
...
-record( repeatingReg_applIDRequestGrp_1351, {refApplID :: refApplID(), refApplReqID :: refApplReqID(), applBegSeqNum :: applBegSeqNum(), applEndSeqNum :: applEndSeqNum(), nestedParties :: #nestedParties{}}).
...
-record( complexEvents, {repeatingReg_complexEvents_1483 = [#repeatingReg_complexEvents_1483{}]}).
...
-record( repeatingReg_relSymDerivSecGrp_146, {instrument :: #instrument{}, secondaryPriceLimits :: #secondaryPriceLimits{}, currency :: currency(), corporateAction :: corporateAction(), instrumentExtension :: #instrumentExtension{}, instrmtLegGrp :: #instrmtLegGrp{}, relSymTransactTime :: relSymTransactTime(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
...
-record( repeatingReg_relSymDerivSecUpdGrp_146, {listUpdateAction :: listUpdateAction(), corporateAction :: corporateAction(), instrument :: #instrument{}, instrumentExtension :: #instrumentExtension{}, secondaryPriceLimits :: #secondaryPriceLimits{}, currency :: currency(), instrmtLegGrp :: #instrmtLegGrp{}, relSymTransactTime :: relSymTransactTime(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( repeatingReg_instrmtMDReqGrp_146, {instrument :: #instrument{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}, currency :: currency(), quoteType :: quoteType(), settlType :: settlType(), settlDate :: settlDate(), mDEntrySize :: mDEntrySize(), mDStreamID :: mDStreamID()}).
...
-record( repeatingReg_strmAsgnRptInstrmtGrp_146, {instrument :: #instrument{}, settlType :: settlType(), streamAsgnType :: streamAsgnType(), mDStreamID :: mDStreamID(), streamAsgnRejReason :: streamAsgnRejReason(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
...
-record( repeatingReg_strmAsgnReqInstrmtGrp_146, {instrument :: #instrument{}, settlType :: settlType(), mDEntrySize :: mDEntrySize(), mDStreamID :: mDStreamID()}).
...
-record( strmAsgnRptInstrmtGrp, {repeatingReg_strmAsgnRptInstrmtGrp_146 = [#repeatingReg_strmAsgnRptInstrmtGrp_146{}]}).
-record( strmAsgnReqInstrmtGrp, {repeatingReg_strmAsgnReqInstrmtGrp_146 = [#repeatingReg_strmAsgnReqInstrmtGrp_146{}]}).
...
-record( strmAsgnReqGrp, {repeatingReg_strmAsgnReqGrp_1499 = [#repeatingReg_strmAsgnReqGrp_1499{}]}).
-record( strmAsgnRptGrp, {repeatingReg_strmAsgnRptGrp_1499 = [#repeatingReg_strmAsgnRptGrp_1499{}]}).
