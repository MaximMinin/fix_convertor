...
simple_test()->
    ...
    BinA = fix_convertor:record2fix(RecA, 'FIX 4.1'),
    BinB = fix_convertor:record2fix(RecBB, 'FIX 4.1'),
    BinC = fix_convertor:record2fix(RecCC, 'FIX 4.1'),
    ?assertEqual(A, BinA),
    ?assertEqual(B, BinB),
    ?assertEqual(C, BinC),
    ?assertEqual(fix_convertor:format(RecB, 'FIX 4.1'),
                 fix_convertor:format(RecBB, 'FIX 4.1')),
    ?assertEqual(fix_convertor:format(#email{}, 'FIX 4.1'),
