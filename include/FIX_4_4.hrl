...
-type tradeReportTransType () :: integer().
...
-type legalConfirm () :: legalConfirmTrue|doesNotConsituteALegalConfirm.
...
-record( rgr_positionAmountData_753, {posAmtType :: posAmtType(), posAmt :: posAmt()}).
...
-record( rgr_trdRegTimestamps_768, {trdRegTimestamp :: trdRegTimestamp(), trdRegTimestampType :: trdRegTimestampType(), trdRegTimestampOrigin :: trdRegTimestampOrigin()}).
...
-record( rgr_allocAckGrp_78, {allocAccount :: allocAccount(), allocAcctIDSource :: allocAcctIDSource(), allocPrice :: allocPrice(), individualAllocID :: individualAllocID(), individualAllocRejCode :: individualAllocRejCode(), allocText :: allocText(), encodedAllocTextLen :: encodedAllocTextLen(), encodedAllocText :: encodedAllocText()}).
...
-record( rgr_execAllocGrp_124, {lastQty :: lastQty(), execID :: execID(), secondaryExecID :: secondaryExecID(), lastPx :: lastPx(), lastParPx :: lastParPx(), lastCapacity :: lastCapacity()}).
...
-record( rgr_execsGrp_124, {execID :: execID()}).
-record( execsGrp, {rgr_execsGrp_124 = [#rgr_execsGrp_124{}]}).
...
-record( rgr_ordListStatGrp_73, {clOrdID :: clOrdID(), secondaryClOrdID :: secondaryClOrdID(), cumQty :: cumQty(), ordStatus :: ordStatus(), workingIndicator :: workingIndicator(), leavesQty :: leavesQty(), cxlQty :: cxlQty(), avgPx :: avgPx(), ordRejReason :: ordRejReason(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
...
-record( rgr_trdCapDtGrp_580, {tradeDate :: tradeDate(), transactTime :: transactTime()}).
-record( trdCapDtGrp, {rgr_trdCapDtGrp_580 = [#rgr_trdCapDtGrp_580{}]}).
-record( rgr_evntGrp_864, {eventType :: eventType(), eventDate :: eventDate(), eventPx :: eventPx(), eventText :: eventText()}).
...
-record( rgr_hop_627, {hopCompID :: hopCompID(), hopSendingTime :: hopSendingTime(), hopRefID :: hopRefID()}).
-record( hop, {rgr_hop_627 = [#rgr_hop_627{}]}).
...
-record( rgr_instrmtStrkPxGrp_428, {instrument :: #instrument{}}).
-record( rgr_posUndInstrmtGrp_711, {underlyingInstrument :: #underlyingInstrument{}, underlyingSettlPrice :: underlyingSettlPrice(), underlyingSettlPriceType :: underlyingSettlPriceType()}).
...
-record( rgr_undInstrmtStrkPxGrp_711, {underlyingInstrument :: #underlyingInstrument{}, prevClosePx :: prevClosePx(), clOrdID :: clOrdID(), secondaryClOrdID :: secondaryClOrdID(), side :: side(), price :: price(), currency :: currency(), text :: text(), encodedTextLen :: encodedTextLen(), encodedText :: encodedText()}).
-record( rgr_quotReqLegsGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legStipulations :: #legStipulations{}, nestedParties :: #nestedParties{}, legBenchmarkCurveData :: #legBenchmarkCurveData{}}).
-record( rgr_legQuotGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legStipulations :: #legStipulations{}, nestedParties :: #nestedParties{}, legPriceType :: legPriceType(), legBidPx :: legBidPx(), legOfferPx :: legOfferPx(), legBenchmarkCurveData :: #legBenchmarkCurveData{}}).
-record( rgr_legQuotStatGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legStipulations :: #legStipulations{}, nestedParties :: #nestedParties{}}).
...
-record( rgr_trdAllocGrp_78, {allocAccount :: allocAccount(), allocAcctIDSource :: allocAcctIDSource(), allocSettlCurrency :: allocSettlCurrency(), individualAllocID :: individualAllocID(), nestedParties2 :: #nestedParties2{}, allocQty :: allocQty()}).
...
-record( rgr_instrmtLegExecGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legStipulations :: #legStipulations{}, legPositionEffect :: legPositionEffect(), legCoveredOrUncovered :: legCoveredOrUncovered(), nestedParties :: #nestedParties{}, legRefID :: legRefID(), legPrice :: legPrice(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legLastPx :: legLastPx()}).
-record( instrmtStrkPxGrp, {rgr_instrmtStrkPxGrp_428 = [#rgr_instrmtStrkPxGrp_428{}]}).
-record( rgr_positionQty_702, {posType :: posType(), longQty :: longQty(), shortQty :: shortQty(), posQtyStatus :: posQtyStatus(), nestedParties :: #nestedParties{}}).
-record( instrmtGrp, {rgr_instrmtGrp_146 = [#rgr_instrmtGrp_146{}]}).
-record( undInstrmtStrkPxGrp, {rgr_undInstrmtStrkPxGrp_711 = [#rgr_undInstrmtStrkPxGrp_711{}]}).
-record( rgr_trdInstrmtLegGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legStipulations :: #legStipulations{}, legPositionEffect :: legPositionEffect(), legCoveredOrUncovered :: legCoveredOrUncovered(), nestedParties :: #nestedParties{}, legRefID :: legRefID(), legPrice :: legPrice(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate(), legLastPx :: legLastPx()}).
...
-record( rgr_legPreAllocGrp_670, {legAllocAccount :: legAllocAccount(), legIndividualAllocID :: legIndividualAllocID(), nestedParties2 :: #nestedParties2{}, legAllocQty :: legAllocQty(), legAllocAcctIDSource :: legAllocAcctIDSource(), legSettlCurrency :: legSettlCurrency()}).
...
-record( rgr_instrmtMDReqGrp_146, {instrument :: #instrument{}, undInstrmtGrp :: #undInstrmtGrp{}, instrmtLegGrp :: #instrmtLegGrp{}}).
...
-record( rgr_legOrdGrp_555, {instrumentLeg :: #instrumentLeg{}, legQty :: legQty(), legSwapType :: legSwapType(), legStipulations :: #legStipulations{}, legPreAllocGrp :: #legPreAllocGrp{}, legPositionEffect :: legPositionEffect(), legCoveredOrUncovered :: legCoveredOrUncovered(), nestedParties :: #nestedParties{}, legRefID :: legRefID(), legPrice :: legPrice(), legSettlType :: legSettlType(), legSettlDate :: legSettlDate()}).
...
-record( rgr_quotSetAckGrp_296, {quoteSetID :: quoteSetID(), underlyingInstrument :: #underlyingInstrument{}, totNoQuoteEntries :: totNoQuoteEntries(), lastFragment :: lastFragment(), quotEntryAckGrp :: #quotEntryAckGrp{}}).
...
-record( logon, {standardHeader :: #standardHeader{}, encryptMethod :: encryptMethod(), heartBtInt :: heartBtInt(), rawDataLength :: rawDataLength(), rawData :: rawData(), resetSeqNumFlag :: resetSeqNumFlag(), nextExpectedMsgSeqNum :: nextExpectedMsgSeqNum(), maxMessageSize :: maxMessageSize(), rgr_logon_384 = [#rgr_logon_384{}], testMessageIndicator :: testMessageIndicator(), username :: username(), password :: password(), standardTrailer :: #standardTrailer{}}).
